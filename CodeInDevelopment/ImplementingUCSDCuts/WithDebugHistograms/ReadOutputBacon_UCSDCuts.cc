...
int ReadOutputBacon_UCSDCuts(std::string infile, std::string treeStr, std::string outfile, std::string MCSample)
{
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    for (unsigned int ielectron=0; ielectron<electron_pt->size(); ielectron++)
    {
      ...
      if(electron.id==1 and electron.pfiso < 0.0588 and electron.pt > 30.0 and fabs(electron.eta) < 2.4)
    ...
    if(v_muplotIdIso.size()==2 and v_electrons.size()==0)
    {
      ...
      {
        h_leading_mu_IdpfIso_MuMu->Fill(v_muplotIdIso.at(0).pfiso);
        h_leading_mu_IdtrkIso_MuMu->Fill(v_muplotIdIso.at(0).trkiso/v_muplotIdIso.at(0).pt);
        h_trailing_mu_IdpfIso_MuMu->Fill(v_muplotIdIso.at(1).pfiso);
        h_trailing_mu_IdtrkIso_MuMu->Fill(v_muplotIdIso.at(1).trkiso/v_muplotIdIso.at(1).pt);
      }
    }
    else if(v_muplotIdIso.size()==1 and v_elplotIdIso.size()==1)
    { 
      double eventWeightEl = 1.0;
      if(MCSample=="Signal")eventWeightEl = v_elplotIdIso.at(0).recoEW*v_muplotIdIso.at(0).recoEW*(1 - (1 - v_elplotIdIso.at(0).triggerEW)*(1 - v_muplotIdIso.at(0).triggerEW));
      else if(MCSample=="MC")eventWeightEl = v_elplotIdIso.at(0).recoEW*v_muplotIdIso.at(0).recoEW*(1 - (1 - v_elplotIdIso.at(0).triggerEW)*(1 - v_muplotIdIso.at(0).triggerEW))*eventWeight;
      if(v_elplotIdIso.at(0).charge*v_muplotIdIso.at(0).charge==1 and v_elplotIdIso.at(0).pt > 30.0 and v_muplotIdIso.at(0).pt > 30.0)
      {
        h_leading_mu_IdpfIso_ElMu->Fill(v_muplotIdIso.at(0).pfiso);
        h_leading_mu_IdtrkIso_ElMu->Fill(v_muplotIdIso.at(0).trkiso/v_muplotIdIso.at(0).pt);
        h_leading_el_IdpfIso_ElMu->Fill(v_elplotIdIso.at(0).pfiso);
        h_leading_el_IdtrkIso_ElMu->Fill(v_elplotIdIso.at(0).trkiso/v_elplotIdIso.at(0).pt);
      }
    }
    else if(v_elplotIdIso.size()==2 and v_muons.size()==0)
    {
      ...
      {
        h_leading_el_IdpfIso_ElEl->Fill(v_elplotIdIso.at(0).pfiso);
        h_leading_el_IdtrkIso_ElEl->Fill(v_elplotIdIso.at(0).trkiso/v_elplotIdIso.at(0).pt);
        h_trailing_el_IdpfIso_ElEl->Fill(v_elplotIdIso.at(1).pfiso);
        h_trailing_el_IdtrkIso_ElEl->Fill(v_elplotIdIso.at(1).trkiso/v_elplotIdIso.at(1).pt);
      }
    }
    ...
    if(v_muplotIso.size()==2 and v_electrons.size()==0)
    {
      ...
      {
        h_leading_mu_pfIso_MuMu->Fill(v_muplotIso.at(0).pfiso);
        h_leading_mu_trkIso_MuMu->Fill(v_muplotIso.at(0).trkiso/v_muplotIso.at(0).pt);
        h_trailing_mu_pfIso_MuMu->Fill(v_muplotIso.at(1).pfiso);
        h_trailing_mu_trkIso_MuMu->Fill(v_muplotIso.at(1).trkiso/v_muplotIso.at(1).pt);
      }
    }
    else if(v_muplotIso.size()==1 and v_elplotIso.size()==1)
    {
      double eventWeightEl = 1.0;
      if(MCSample=="Signal")eventWeightEl = v_elplotIso.at(0).recoEW*v_muplotIso.at(0).recoEW*(1 - (1 - v_elplotIso.at(0).triggerEW)*(1 - v_muplotIso.at(0).triggerEW));
      else if(MCSample=="MC")eventWeightEl = v_elplotIso.at(0).recoEW*v_muplotIso.at(0).recoEW*(1 - (1 - v_elplotIso.at(0).triggerEW)*(1 - v_muplotIso.at(0).triggerEW))*eventWeight;
      if(v_elplotIso.at(0).charge*v_muplotIso.at(0).charge==1 and v_elplotIso.at(0).pt > 30.0 and v_muplotIso.at(0).pt > 30.0)
      {
        h_leading_mu_pfIso_ElMu->Fill(v_muplotIso.at(0).pfiso);
        h_leading_mu_trkIso_ElMu->Fill(v_muplotIso.at(0).trkiso/v_muplotIso.at(0).pt);
        h_leading_el_pfIso_ElMu->Fill(v_elplotIso.at(0).pfiso);
        h_leading_el_trkIso_ElMu->Fill(v_elplotIso.at(0).trkiso/v_elplotIso.at(0).pt);
      }
    }
    else if(v_elplotIso.size()==2 and v_muons.size()==0)
    {
      ...
      {
        h_leading_el_pfIso_ElEl->Fill(v_elplotIso.at(0).pfiso);
        h_leading_el_trkIso_ElEl->Fill(v_elplotIso.at(0).trkiso/v_elplotIso.at(0).pt);
        h_trailing_el_pfIso_ElEl->Fill(v_elplotIso.at(1).pfiso);
        h_trailing_el_trkIso_ElEl->Fill(v_elplotIso.at(1).trkiso/v_elplotIso.at(1).pt);
      }
    }
