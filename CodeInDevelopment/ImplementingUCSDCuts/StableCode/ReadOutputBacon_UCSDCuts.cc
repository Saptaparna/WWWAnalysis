...
int ReadOutputBacon_UCSDCuts(std::string infile, std::string treeStr, std::string outfile, std::string MCSample)
{
  ...
  tree->SetBranchAddress("bjet_weight", &(bjet_weight));
  ...
  double cut1_mumu, cut2_mumu, cut3_mumu, cut4_mumu, cut5_mumu, cut6_mumu, cut7_mumu, cut8_mumu, cutFatJet_mumu;
  cut1_mumu = cut2_mumu = cut3_mumu = cut4_mumu = cut5_mumu = cut6_mumu = cut7_mumu = cut8_mumu = cutFatJet_mumu = 0.0;
  double cut1_elel, cut2_elel, cut3_elel, cut4_elel, cut5_elel, cut6_elel, cut7_elel, cut8_elel, cutFatJet_elel;
  cut1_elel = cut2_elel = cut3_elel = cut4_elel = cut5_elel = cut6_elel = cut7_elel = cut8_elel = cutFatJet_elel = 0.0;
  double cut1_elmu, cut2_elmu, cut3_elmu, cut4_elmu, cut5_elmu, cut6_elmu, cut7_elmu, cut8_elmu, cut9_elmu, cutFatJet_elmu; 
  cut1_elmu = cut2_elmu = cut3_elmu = cut4_elmu = cut5_elmu = cut6_elmu = cut7_elmu = cut8_elmu = cut9_elmu = cutFatJet_elmu = 0.0;
  ...
  HistCollection mumuHistFatJet;
  initializeHistCollection(mumuHistFatJet, "2SSTLLVFatJet_MuMu");
  ...
  HistCollection elelHistFatJet;
  initializeHistCollection(elelHistFatJet, "2SSTLLVFatJet_ElEl");
  ...
  HistCollection elmuHistFatJet;
  initializeHistCollection(elmuHistFatJet, "2SSTLLVFatJet_ElMu");
...
/* 
  Float_t rebin_array_Iso[] = {0.0, 0.001, 0.002, 0.003, 0.004, 0.005, 0.006, 0.007, 0.008, 0.009, 0.010, 0.020, 0.030, 0.050, 0.10, 0.20, 10.0};
  Int_t  binIso = sizeof(rebin_array_Iso)/sizeof(Float_t) - 1;
   
  TH1D *h_leading_mu_Iso_Tune_MuMu = new TH1D("h_leading_mu_Iso_Tune_MuMu", "h_leading_mu_Iso_Tune_MuMu", binIso, rebin_array_Iso); h_leading_mu_Iso_Tune_MuMu->Sumw2();
  TH1D *h_trailing_mu_Iso_Tune_MuMu = new TH1D("h_trailing_mu_Iso_Tune_MuMu", "h_trailing_mu_Iso_Tune_MuMu", binIso, rebin_array_Iso); h_trailing_mu_Iso_Tune_MuMu->Sumw2();
  
  TH1D *h_leading_el_Iso_Tune_ElEl = new TH1D("h_leading_el_Iso_Tune_ElEl", "h_leading_el_Iso_Tune_ElEl", binIso, rebin_array_Iso); h_leading_el_Iso_Tune_ElEl->Sumw2();
  TH1D *h_trailing_el_Iso_Tune_ElEl = new TH1D("h_trailing_el_Iso_Tune_ElEl", "h_trailing_el_Iso_Tune_ElEl", binIso, rebin_array_Iso); h_trailing_el_Iso_Tune_ElEl->Sumw2();

  TH1D *h_leading_mu_Iso_Tune_ElMu = new TH1D("h_leading_mu_Iso_Tune_ElMu", "h_leading_mu_Iso_Tune_ElMu", binIso, rebin_array_Iso); h_leading_mu_Iso_Tune_ElMu->Sumw2();
  TH1D *h_leading_el_Iso_Tune_ElMu = new TH1D("h_leading_el_Iso_Tune_ElMu", "h_leading_el_Iso_Tune_ElMu", binIso, rebin_array_Iso); h_leading_el_Iso_Tune_ElMu->Sumw2();  
 
  TH1D *h_leading_mu_d0_Tune_MuMu = new TH1D("h_leading_mu_d0_Tune_MuMu", "h_leading_mu_d0_Tune_MuMu", binIso, rebin_array_Iso); h_leading_mu_d0_Tune_MuMu->Sumw2();
  TH1D *h_trailing_mu_d0_Tune_MuMu = new TH1D("h_trailing_mu_d0_Tune_MuMu", "h_trailing_mu_d0_Tune_MuMu", binIso, rebin_array_Iso); h_trailing_mu_d0_Tune_MuMu->Sumw2();

  TH1D *h_leading_el_d0_Tune_ElEl = new TH1D("h_leading_el_d0_Tune_ElEl", "h_leading_el_d0_Tune_ElEl", binIso, rebin_array_Iso); h_leading_el_d0_Tune_ElEl->Sumw2();
  TH1D *h_trailing_el_d0_Tune_ElEl = new TH1D("h_trailing_el_d0_Tune_ElEl", "h_trailing_el_d0_Tune_ElEl", binIso, rebin_array_Iso); h_trailing_el_d0_Tune_ElEl->Sumw2();

  TH1D *h_leading_mu_d0_Tune_ElMu = new TH1D("h_leading_mu_d0_Tune_ElMu", "h_leading_mu_d0_Tune_ElMu", binIso, rebin_array_Iso); h_leading_mu_d0_Tune_ElMu->Sumw2();
  TH1D *h_leading_el_d0_Tune_ElMu = new TH1D("h_leading_el_d0_Tune_ElMu", "h_leading_el_d0_Tune_ElMu", binIso, rebin_array_Iso); h_leading_el_d0_Tune_ElMu->Sumw2();

  TH1D *h_leading_mu_dz_Tune_MuMu = new TH1D("h_leading_mu_dz_Tune_MuMu", "h_leading_mu_dz_Tune_MuMu", binIso, rebin_array_Iso); h_leading_mu_dz_Tune_MuMu->Sumw2();
  TH1D *h_trailing_mu_dz_Tune_MuMu = new TH1D("h_trailing_mu_dz_Tune_MuMu", "h_trailing_mu_dz_Tune_MuMu", binIso, rebin_array_Iso); h_trailing_mu_dz_Tune_MuMu->Sumw2();

  TH1D *h_leading_el_dz_Tune_ElEl = new TH1D("h_leading_el_dz_Tune_ElEl", "h_leading_el_dz_Tune_ElEl", binIso, rebin_array_Iso); h_leading_el_dz_Tune_ElEl->Sumw2();
  TH1D *h_trailing_el_dz_Tune_ElEl = new TH1D("h_trailing_el_dz_Tune_ElEl", "h_trailing_el_dz_Tune_ElEl", binIso, rebin_array_Iso); h_trailing_el_dz_Tune_ElEl->Sumw2();

  TH1D *h_leading_mu_dz_Tune_ElMu = new TH1D("h_leading_mu_dz_Tune_ElMu", "h_leading_mu_dz_Tune_ElMu", binIso, rebin_array_Iso); h_leading_mu_dz_Tune_ElMu->Sumw2();
  TH1D *h_leading_el_dz_Tune_ElMu = new TH1D("h_leading_el_dz_Tune_ElMu", "h_leading_el_dz_Tune_ElMu", binIso, rebin_array_Iso); h_leading_el_dz_Tune_ElMu->Sumw2();

  TH1D *h_leading_mu_Iso_WithIpCut_MuMu = new TH1D("h_leading_mu_Iso_WithIpCut_MuMu", "h_leading_mu_Iso_WithIpCut_MuMu", binIso, rebin_array_Iso); h_leading_mu_Iso_WithIpCut_MuMu->Sumw2();
  TH1D *h_trailing_mu_Iso_WithIpCut_MuMu = new TH1D("h_trailing_mu_Iso_WithIpCut_MuMu", "h_trailing_mu_Iso_WithIpCut_MuMu", binIso, rebin_array_Iso); h_trailing_mu_Iso_WithIpCut_MuMu->Sumw2();

  TH1D *h_leading_mu_Iso_WithIpCut_ElMu = new TH1D("h_leading_mu_Iso_WithIpCut_ElMu", "h_leading_mu_Iso_WithIpCut_ElMu", binIso, rebin_array_Iso); h_leading_mu_Iso_WithIpCut_ElMu->Sumw2();
  TH1D *h_leading_el_Iso_WithIpCut_ElMu = new TH1D("h_leading_el_Iso_WithIpCut_ElMu", "h_leading_el_Iso_WithIpCut_ElMu", binIso, rebin_array_Iso); h_leading_el_Iso_WithIpCut_ElMu->Sumw2();

  TH1D *h_leading_el_Iso_WithIpCut_ElEl = new TH1D("h_leading_el_Iso_WithIpCut_ElEl", "h_leading_el_Iso_WithIpCut_ElEl", binIso, rebin_array_Iso); h_leading_el_Iso_WithIpCut_ElEl->Sumw2();
  TH1D *h_trailing_el_Iso_WithIpCut_ElEl = new TH1D("h_trailing_el_Iso_WithIpCut_ElEl", "h_trailing_el_Iso_WithIpCut_ElEl", binIso, rebin_array_Iso); h_trailing_el_Iso_WithIpCut_ElEl->Sumw2();

  TH1D *h_leading_mu_d0_WithIsoCut_MuMu = new TH1D("h_leading_mu_d0_WithIsoCut_MuMu", "h_leading_mu_d0_WithIsoCut_MuMu", binIso, rebin_array_Iso); h_leading_mu_d0_WithIsoCut_MuMu->Sumw2();
  TH1D *h_trailing_mu_d0_WithIsoCut_MuMu = new TH1D("h_trailing_mu_d0_WithIsoCut_MuMu", "h_trailing_mu_d0_WithIsoCut_MuMu", binIso, rebin_array_Iso); h_trailing_mu_d0_WithIsoCut_MuMu->Sumw2();

  TH1D *h_leading_el_d0_WithIsoCut_ElEl = new TH1D("h_leading_el_d0_WithIsoCut_ElEl", "h_leading_el_d0_WithIsoCut_ElEl", binIso, rebin_array_Iso); h_leading_el_d0_WithIsoCut_ElEl->Sumw2();
  TH1D *h_trailing_el_d0_WithIsoCut_ElEl = new TH1D("h_trailing_el_d0_WithIsoCut_ElEl", "h_trailing_el_d0_WithIsoCut_ElEl", binIso, rebin_array_Iso); h_trailing_el_d0_WithIsoCut_ElEl->Sumw2();

  TH1D *h_leading_mu_d0_WithIsoCut_ElMu = new TH1D("h_leading_mu_d0_WithIsoCut_ElMu", "h_leading_mu_d0_WithIsoCut_ElMu", binIso, rebin_array_Iso); h_leading_mu_d0_WithIsoCut_ElMu->Sumw2();
  TH1D *h_leading_el_d0_WithIsoCut_ElMu = new TH1D("h_leading_el_d0_WithIsoCut_ElMu", "h_leading_el_d0_WithIsoCut_ElMu", binIso, rebin_array_Iso); h_leading_el_d0_WithIsoCut_ElMu->Sumw2();

  TH1D *h_leading_mu_dz_WithIsoCut_MuMu = new TH1D("h_leading_mu_dz_WithIsoCut_MuMu", "h_leading_mu_dz_WithIsoCut_MuMu", binIso, rebin_array_Iso); h_leading_mu_dz_WithIsoCut_MuMu->Sumw2();
  TH1D *h_trailing_mu_dz_WithIsoCut_MuMu = new TH1D("h_trailing_mu_dz_WithIsoCut_MuMu", "h_trailing_mu_dz_WithIsoCut_MuMu", binIso, rebin_array_Iso); h_trailing_mu_dz_WithIsoCut_MuMu->Sumw2();

  TH1D *h_leading_el_dz_WithIsoCut_ElEl = new TH1D("h_leading_el_dz_WithIsoCut_ElEl", "h_leading_el_dz_WithIsoCut_ElEl", binIso, rebin_array_Iso); h_leading_el_dz_WithIsoCut_ElEl->Sumw2();
  TH1D *h_trailing_el_dz_WithIsoCut_ElEl = new TH1D("h_trailing_el_dz_WithIsoCut_ElEl", "h_trailing_el_dz_WithIsoCut_ElEl", binIso, rebin_array_Iso); h_trailing_el_dz_WithIsoCut_ElEl->Sumw2();

  TH1D *h_leading_mu_dz_WithIsoCut_ElMu = new TH1D("h_leading_mu_dz_WithIsoCut_ElMu", "h_leading_mu_dz_WithIsoCut_ElMu", binIso, rebin_array_Iso); h_leading_mu_dz_WithIsoCut_ElMu->Sumw2();
  TH1D *h_leading_el_dz_WithIsoCut_ElMu = new TH1D("h_leading_el_dz_WithIsoCut_ElMu", "h_leading_el_dz_WithIsoCut_ElMu", binIso, rebin_array_Iso); h_leading_el_dz_WithIsoCut_ElMu->Sumw2();*/
  ...
  TH1D *h_leading_mu_Iso_WithIpCut_MuMu = new TH1D("h_leading_mu_Iso_WithIpCut_MuMu", "h_leading_mu_Iso_WithIpCut_MuMu", 20000.0, -10.0, 10.0); h_leading_mu_Iso_WithIpCut_MuMu->Sumw2();
  TH1D *h_trailing_mu_Iso_WithIpCut_MuMu = new TH1D("h_trailing_mu_Iso_WithIpCut_MuMu", "h_trailing_mu_Iso_WithIpCut_MuMu", 20000.0, -10.0, 10.0); h_trailing_mu_Iso_WithIpCut_MuMu->Sumw2();

  TH1D *h_leading_mu_Iso_WithIpCut_ElMu = new TH1D("h_leading_mu_Iso_WithIpCut_ElMu", "h_leading_mu_Iso_WithIpCut_ElMu", 20000.0, -10.0, 10.0); h_leading_mu_Iso_WithIpCut_ElMu->Sumw2();
  TH1D *h_leading_el_Iso_WithIpCut_ElMu = new TH1D("h_leading_el_Iso_WithIpCut_ElMu", "h_leading_el_Iso_WithIpCut_ElMu", 20000.0, -10.0, 10.0); h_leading_el_Iso_WithIpCut_ElMu->Sumw2();

  TH1D *h_leading_el_Iso_WithIpCut_ElEl = new TH1D("h_leading_el_Iso_WithIpCut_ElEl", "h_leading_el_Iso_WithIpCut_ElEl", 20000.0, -10.0, 10.0); h_leading_el_Iso_WithIpCut_ElEl->Sumw2();
  TH1D *h_trailing_el_Iso_WithIpCut_ElEl = new TH1D("h_trailing_el_Iso_WithIpCut_ElEl", "h_trailing_el_Iso_WithIpCut_ElEl", 20000.0, -10.0, 10.0); h_trailing_el_Iso_WithIpCut_ElEl->Sumw2();

  TH1D *h_leading_mu_d0_WithIsoCut_MuMu = new TH1D("h_leading_mu_d0_WithIsoCut_MuMu", "h_leading_mu_d0_WithIsoCut_MuMu", 20000.0, -10.0, 10.0); h_leading_mu_d0_WithIsoCut_MuMu->Sumw2();
  TH1D *h_trailing_mu_d0_WithIsoCut_MuMu = new TH1D("h_trailing_mu_d0_WithIsoCut_MuMu", "h_trailing_mu_d0_WithIsoCut_MuMu", 20000.0, -10.0, 10.0); h_trailing_mu_d0_WithIsoCut_MuMu->Sumw2();

  TH1D *h_leading_el_d0_WithIsoCut_ElEl = new TH1D("h_leading_el_d0_WithIsoCut_ElEl", "h_leading_el_d0_WithIsoCut_ElEl", 20000.0, -10.0, 10.0); h_leading_el_d0_WithIsoCut_ElEl->Sumw2();
  TH1D *h_trailing_el_d0_WithIsoCut_ElEl = new TH1D("h_trailing_el_d0_WithIsoCut_ElEl", "h_trailing_el_d0_WithIsoCut_ElEl", 20000.0, -10.0, 10.0); h_trailing_el_d0_WithIsoCut_ElEl->Sumw2();

  TH1D *h_leading_mu_d0_WithIsoCut_ElMu = new TH1D("h_leading_mu_d0_WithIsoCut_ElMu", "h_leading_mu_d0_WithIsoCut_ElMu", 20000.0, -10.0, 10.0); h_leading_mu_d0_WithIsoCut_ElMu->Sumw2();
  TH1D *h_leading_el_d0_WithIsoCut_ElMu = new TH1D("h_leading_el_d0_WithIsoCut_ElMu", "h_leading_el_d0_WithIsoCut_ElMu", 20000.0, -10.0, 10.0); h_leading_el_d0_WithIsoCut_ElMu->Sumw2();

  TH1D *h_leading_mu_dz_WithIsoCut_MuMu = new TH1D("h_leading_mu_dz_WithIsoCut_MuMu", "h_leading_mu_dz_WithIsoCut_MuMu", 20000.0, -10.0, 10.0); h_leading_mu_dz_WithIsoCut_MuMu->Sumw2();
  TH1D *h_trailing_mu_dz_WithIsoCut_MuMu = new TH1D("h_trailing_mu_dz_WithIsoCut_MuMu", "h_trailing_mu_dz_WithIsoCut_MuMu", 20000.0, -10.0, 10.0); h_trailing_mu_dz_WithIsoCut_MuMu->Sumw2();

  TH1D *h_leading_el_dz_WithIsoCut_ElEl = new TH1D("h_leading_el_dz_WithIsoCut_ElEl", "h_leading_el_dz_WithIsoCut_ElEl", 20000.0, -10.0, 10.0); h_leading_el_dz_WithIsoCut_ElEl->Sumw2();
  TH1D *h_trailing_el_dz_WithIsoCut_ElEl = new TH1D("h_trailing_el_dz_WithIsoCut_ElEl", "h_trailing_el_dz_WithIsoCut_ElEl", 20000.0, -10.0, 10.0); h_trailing_el_dz_WithIsoCut_ElEl->Sumw2();

  TH1D *h_leading_mu_dz_WithIsoCut_ElMu = new TH1D("h_leading_mu_dz_WithIsoCut_ElMu", "h_leading_mu_dz_WithIsoCut_ElMu", 20000.0, -10.0, 10.0); h_leading_mu_dz_WithIsoCut_ElMu->Sumw2();
  TH1D *h_leading_el_dz_WithIsoCut_ElMu = new TH1D("h_leading_el_dz_WithIsoCut_ElMu", "h_leading_el_dz_WithIsoCut_ElMu", 20000.0, -10.0, 10.0); h_leading_el_dz_WithIsoCut_ElMu->Sumw2();


  //nfatjets
  TH1D *h_nfatJets_noCut_MuMu = new TH1D("h_nfatJets_noCut_MuMu", "h_nfatJets_noCut_MuMu", 10, -0.5, 9.5); h_nfatJets_noCut_MuMu->Sumw2();
  TH1D *h_nfatJets_noCut_ElEl = new TH1D("h_nfatJets_noCut_ElEl", "h_nfatJets_noCut_ElEl", 10, -0.5, 9.5); h_nfatJets_noCut_ElEl->Sumw2();
  TH1D *h_nfatJets_noCut_ElMu = new TH1D("h_nfatJets_noCut_ElMu", "h_nfatJets_noCut_ElMu", 10, -0.5, 9.5); h_nfatJets_noCut_ElMu->Sumw2(); 
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    for(unsigned int iselJet=0; iselJet<v_jets.size(); ++iselJet)
    {
      ...
      if(fabs(v_jets.at(iselJet).jetEta)<5.0 and v_jets.at(iselJet).jetPt>30.0)
      {
        ...
        if(v_jets.at(iselJet).jetPt>180.0)
        {
          Jet.JetLV.SetPtEtaPhiM(v_jets.at(iselJet).jetPt, v_jets.at(iselJet).jetEta, v_jets.at(iselJet).jetPhi, v_jets.at(iselJet).jetMass);
          Jet.BTag_CSV = v_jets.at(iselJet).jetCSV;
          for(unsigned int iselFatJet=0; iselFatJet<v_fatJets.size(); ++iselFatJet) 
          {
            TLorentzVector FatJet = fillTLorentzVector(v_fatJets.at(iselFatJet).ak8JetPt, v_fatJets.at(iselFatJet).ak8JetEta, v_fatJets.at(iselFatJet).ak8JetPhi, v_fatJets.at(iselFatJet).ak8Jetsd0);
            double DRjet_fatJet = Jet.JetLV.DeltaR(FatJet);
            //if(DRjet_fatJet<0.8) isGoodJet=false;
          }
        }
    ...
    if(v_muIpIsoTune.size()==2 and v_electrons.size()==0 and v_selectedJets.size()==1)
    {
      ...
      if(v_muIpIsoTune.at(0).charge*v_muIpIsoTune.at(1).charge==1 and v_muIpIsoTune.at(0).pt > 30.0 and v_muIpIsoTune.at(1).pt > 30.0)
      {
        ...
        if(v_muIpIsoTune.at(0).pfiso < 0.10) h_leading_mu_d0_WithIsoCut_MuMu->Fill(fabs(v_muIpIsoTune.at(0).d0), eventWeightMu);
        if(v_muIpIsoTune.at(1).pfiso < 0.10) h_trailing_mu_d0_WithIsoCut_MuMu->Fill(fabs(v_muIpIsoTune.at(1).d0), eventWeightMu);
        if(v_muIpIsoTune.at(0).pfiso < 0.10) h_leading_mu_dz_WithIsoCut_MuMu->Fill(fabs(v_muIpIsoTune.at(0).dz), eventWeightMu);
        if(v_muIpIsoTune.at(1).pfiso < 0.10) h_trailing_mu_dz_WithIsoCut_MuMu->Fill(fabs(v_muIpIsoTune.at(1).dz), eventWeightMu);
        if(fabs(v_muIpIsoTune.at(0).d0) < 0.2 and fabs(v_muIpIsoTune.at(0).dz) < 0.5) h_leading_mu_Iso_WithIpCut_MuMu->Fill(v_muIpIsoTune.at(0).pfiso, eventWeightMu);
        if(fabs(v_muIpIsoTune.at(1).d0) < 0.2 and fabs(v_muIpIsoTune.at(1).dz) < 0.5) h_trailing_mu_Iso_WithIpCut_MuMu->Fill(v_muIpIsoTune.at(1).pfiso, eventWeightMu);
      }
    }
    ...
    {   
      ...
      if(v_muIpIsoTune.at(0).charge*v_elIpIsoTune.at(0).charge==1 and v_muIpIsoTune.at(0).pt > 30.0 and v_elIpIsoTune.at(0).pt > 30.0)
      {
        ...
        if(v_muIpIsoTune.at(0).pfiso < 0.10) h_leading_mu_d0_WithIsoCut_ElMu->Fill(fabs(v_muIpIsoTune.at(0).d0), eventWeightElMu);
        if(v_elIpIsoTune.at(0).pfiso < 0.06) h_leading_el_d0_WithIsoCut_ElMu->Fill(fabs(v_elIpIsoTune.at(0).d0), eventWeightElMu);
        if(v_muIpIsoTune.at(0).pfiso < 0.10) h_leading_mu_dz_WithIsoCut_ElMu->Fill(fabs(v_muIpIsoTune.at(0).dz), eventWeightElMu);
        if(v_elIpIsoTune.at(0).pfiso < 0.06) h_leading_el_dz_WithIsoCut_ElMu->Fill(fabs(v_elIpIsoTune.at(0).dz), eventWeightElMu);
        if(fabs(v_muIpIsoTune.at(0).d0) < 0.2 and fabs(v_muIpIsoTune.at(0).dz) < 0.5) h_leading_mu_Iso_WithIpCut_ElMu->Fill(v_muIpIsoTune.at(0).pfiso, eventWeightElMu);
        if(fabs(v_elIpIsoTune.at(0).d0) < 0.05 and fabs(v_elIpIsoTune.at(0).dz) < 0.1) h_leading_el_Iso_WithIpCut_ElMu->Fill(v_elIpIsoTune.at(0).pfiso, eventWeightElMu);
      }
    }
    else if(v_elIpIsoTune.size()==2 and v_muons.size()==0 and v_selectedJets.size()==1)
    {
      ...
      { 
        ...
        if(v_elIpIsoTune.at(0).pfiso < 0.06) h_leading_el_d0_WithIsoCut_ElEl->Fill(fabs(v_elIpIsoTune.at(0).d0), eventWeightEl);
        if(v_elIpIsoTune.at(1).pfiso < 0.06) h_trailing_el_d0_WithIsoCut_ElEl->Fill(fabs(v_elIpIsoTune.at(1).d0), eventWeightEl);
        if(v_elIpIsoTune.at(0).pfiso < 0.06) h_leading_el_dz_WithIsoCut_ElEl->Fill(fabs(v_elIpIsoTune.at(0).dz), eventWeightEl);
        if(v_elIpIsoTune.at(1).pfiso < 0.06) h_trailing_el_dz_WithIsoCut_ElEl->Fill(fabs(v_elIpIsoTune.at(1).dz), eventWeightEl);
        if(fabs(v_elIpIsoTune.at(0).d0) < 0.05 and fabs(v_elIpIsoTune.at(0).dz) < 0.1) h_leading_el_Iso_WithIpCut_ElEl->Fill(v_elIpIsoTune.at(0).pfiso, eventWeightEl);
        if(fabs(v_elIpIsoTune.at(1).d0) < 0.05 and fabs(v_elIpIsoTune.at(1).dz) < 0.1) h_trailing_el_Iso_WithIpCut_ElEl->Fill(v_elIpIsoTune.at(1).pfiso, eventWeightEl);
      }
    }
    ...
    if(v_muons.size() == 2 and v_electrons.size()==0)
    {
      ...
      double jet1pt, jet1eta, jet1phi, jet2pt, jet2eta, jet2phi, bjet1pt, bjet1csv, bjet2csv, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, fatJetPt, fatJetPhi, fatJetEta;
      jet1pt = jet1eta = jet1phi = jet2pt = jet2eta = jet2phi = bjet1csv = bjet2csv = bjet1pt = bjet1eta = bjet1phi = bjet2pt = bjet2eta = bjet2phi = fatJetPt = fatJetPhi = fatJetEta = 0.0;
      if(v_muons.at(0).charge*v_muons.at(1).charge==1 and v_muons.at(0).pt > 30.0 and v_muons.at(1).pt > 30.0)
      {
        ...
        if(v_looseElectrons.size()==0 and v_looseMuons.size()==0) 
        {
          ...
          h_nfatJets_noCut_MuMu->Fill(v_fatJets.size(), eventWeightMu);
          if(v_selectedJets.size()>=2 and fabs(v_selectedJets.at(0).JetLV.Eta()) < 2.5 and fabs(v_selectedJets.at(1).JetLV.Eta()) < 2.5)
          {
            ...
            {
              cut4_mumu+=eventWeightMu*bjet_weight;
              fillMuHistCollection(mumuHistCut4, mu1.Pt(), mu2.Pt(), mu1.Eta(), mu2.Eta(), mu1.Phi(), mu2.Phi(), (mu1+mu2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightMu*bjet_weight);
              ...
              h_TotalEvents_MuMu->Fill(4, eventWeightMu*bjet_weight);
              if(invMassJJ > 60 and invMassJJ < 100) 
              {
                cut5_mumu+=eventWeightMu*bjet_weight;
                fillMuHistCollection(mumuHistCut5, mu1.Pt(), mu2.Pt(), mu1.Eta(), mu2.Eta(), mu1.Phi(), mu2.Phi(), (mu1+mu2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightMu*bjet_weight);
                double invMassLeadingJJ = (v_selectedJets.at(0).JetLV + v_selectedJets.at(1).JetLV).M();
                double deltaEta = fabs(v_selectedJets.at(0).JetLV.Eta()-v_selectedJets.at(1).JetLV.Eta());
                h_TotalEvents_MuMu->Fill(5, eventWeightMu*bjet_weight);
                if(invMassLeadingJJ < 400.0 and deltaEta < 1.5)
                {
                  cut6_mumu+=eventWeightMu*bjet_weight;
                  fillMuHistCollection(mumuHistCut6, mu1.Pt(), mu2.Pt(), mu1.Eta(), mu2.Eta(), mu1.Phi(), mu2.Phi(), (mu1+mu2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightMu*bjet_weight);   
                  h_TotalEvents_MuMu->Fill(6, eventWeightMu*bjet_weight);
                  if(met > 40.0) 
                  {
                    cut7_mumu+=eventWeightMu*bjet_weight;
                    fillMuHistCollection(mumuHistCut7, mu1.Pt(), mu2.Pt(), mu1.Eta(), mu2.Eta(), mu1.Phi(), mu2.Phi(), (mu1+mu2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightMu*bjet_weight);
                    h_TotalEvents_MuMu->Fill(7, eventWeightMu*bjet_weight);
                    if((mu1+mu2).M() > 40.0) 
                    {
                      cut8_mumu+=eventWeightMu*bjet_weight;
                      fillMuHistCollection(mumuHistCut8, mu1.Pt(), mu2.Pt(), mu1.Eta(), mu2.Eta(), mu1.Phi(), mu2.Phi(), (mu1+mu2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightMu*bjet_weight);
                      h_TotalEvents_MuMu->Fill(8, eventWeightMu*bjet_weight);
                    }//Mll > 40.0
                  }//met > 40.0 
          ...
          else if(v_fatJets.size() > 0 and v_fatJets.at(0).ak8JetPt > 180.0)
          {
            cutFatJet_mumu+=eventWeightMu;
            if(v_selectedBJets.size()>0) bjet1pt = v_selectedBJets.at(0).JetLV.Pt();
            if(v_selectedBJets.size()>0) bjet1eta = v_selectedBJets.at(0).JetLV.Eta();
            if(v_selectedBJets.size()>0) bjet1phi = v_selectedBJets.at(0).JetLV.Phi();
            if(v_selectedBJets.size()>0) bjet1csv = v_selectedBJets.at(0).BTag_CSV;
            if(v_selectedBJets.size()>1) bjet2csv = v_selectedBJets.at(1).BTag_CSV;
            fatJetPt = v_fatJets.at(0).ak8JetPt;
            fatJetEta = v_fatJets.at(0).ak8JetEta; 
            fatJetPhi = v_fatJets.at(0).ak8JetPhi;
            fillMuHistCollectionWithFatJet(mumuHistFatJet, mu1.Pt(), mu2.Pt(), mu1.Eta(), mu2.Eta(), mu1.Phi(), mu2.Phi(), (mu1+mu2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_fatJets.size(), jet1pt, jet2pt, jet1eta, jet2eta, jet1phi, jet2phi, bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, fatJetPt, fatJetEta, fatJetPhi, v_fatJets.at(0).ak8JetPrunmass, v_fatJets.at(0).ak8JetTrimmass, v_fatJets.at(0).ak8Jetsd0, (double)v_fatJets.at(0).ak8JetTau2/(double)v_fatJets.at(0).ak8JetTau1, eventWeightMu);
            h_TotalEvents_MuMu->Fill(10, eventWeightMu);
            if(v_fatJets.at(0).ak8JetPrunmass > 50 and v_fatJets.at(0).ak8JetPrunmass < 100) h_TotalEvents_MuMu->Fill(11, eventWeightMu);
            if(v_fatJets.at(0).ak8JetTrimmass > 50 and v_fatJets.at(0).ak8JetTrimmass < 100) h_TotalEvents_MuMu->Fill(12, eventWeightMu);
            if(v_fatJets.at(0).ak8Jetsd0 > 50 and v_fatJets.at(0).ak8Jetsd0 < 100) h_TotalEvents_MuMu->Fill(13, eventWeightMu);
            if(v_fatJets.at(0).ak8Jetsd0 > 50 and (double)v_fatJets.at(0).ak8JetTau2/(double)v_fatJets.at(0).ak8JetTau1 < 0.6) h_TotalEvents_MuMu->Fill(14, eventWeightMu);
            if(v_fatJets.at(0).ak8Jetsd0 > 70 and v_fatJets.at(0).ak8Jetsd0 < 90) h_TotalEvents_MuMu->Fill(15, eventWeightMu); 
          }
        }//loose lepton veto
    ...
    else if(v_electrons.size() == 1 and v_muons.size()==1)
    {
      ...
      if(v_electrons.at(0).charge*v_muons.at(0).charge==1 and v_electrons.at(0).pt > 30.0 and v_muons.at(0).pt > 30.0)
      {
        ...
        if(v_looseElectrons.size()==0 and v_looseMuons.size()==0)
        {
          ...
          h_nfatJets_noCut_ElMu->Fill(v_fatJets.size(), eventWeightElMu);
          if(v_selectedJets.size()>=2 and fabs(v_selectedJets.at(0).JetLV.Eta()) < 2.5 and fabs(v_selectedJets.at(1).JetLV.Eta()) < 2.5)
          {
            ...
            if(v_selectedBJets.size()==0)
            {
              cut4_elmu+=eventWeightElMu*bjet_weight;
              fillElMuHistCollection(elmuHistCut4, el1.Pt(), mu1.Pt(), el1.Eta(), mu1.Eta(), el1.Phi(), mu1.Phi(), (el1+mu1).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightElMu*bjet_weight);
              double invMassLeadingJJ = (v_selectedJets.at(0).JetLV + v_selectedJets.at(1).JetLV).M();
              double deltaEta = fabs(v_selectedJets.at(0).JetLV.Eta()-v_selectedJets.at(1).JetLV.Eta());
              h_TotalEvents_ElMu->Fill(4, eventWeightElMu*bjet_weight);
              if(invMassJJ > 60 and invMassJJ < 100)
              {
                cut5_elmu+=eventWeightElMu*bjet_weight;
                fillElMuHistCollection(elmuHistCut5, el1.Pt(), mu1.Pt(), el1.Eta(), mu1.Eta(), el1.Phi(), mu1.Phi(), (el1+mu1).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightElMu*bjet_weight);
                double invMassLeadingJJ = (v_selectedJets.at(0).JetLV + v_selectedJets.at(1).JetLV).M();
                double deltaEta = fabs(v_selectedJets.at(0).JetLV.Eta()-v_selectedJets.at(1).JetLV.Eta());
                h_TotalEvents_ElMu->Fill(5, eventWeightElMu*bjet_weight);
                if(invMassLeadingJJ < 400.0 and deltaEta < 1.5)
                {
                  cut6_elmu+=eventWeightElMu*bjet_weight;
                  fillElMuHistCollection(elmuHistCut6, el1.Pt(), mu1.Pt(), el1.Eta(), mu1.Eta(), el1.Phi(), mu1.Phi(), (el1+mu1).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightElMu*bjet_weight);
                  h_TotalEvents_ElMu->Fill(6, eventWeightElMu*bjet_weight);
                  if(met > 40.0)
                  {
                    cut7_elmu+=eventWeightElMu*bjet_weight;
                    fillElMuHistCollection(elmuHistCut7, el1.Pt(), mu1.Pt(), el1.Eta(), mu1.Eta(), el1.Phi(), mu1.Phi(), (el1+mu1).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightElMu*bjet_weight);
                    h_TotalEvents_ElMu->Fill(7, eventWeightElMu*bjet_weight);
                    if((el1+mu1).M() > 40.0)
                    {
                      cut8_elmu+=eventWeightElMu*bjet_weight;
                      fillElMuHistCollection(elmuHistCut8, el1.Pt(), mu1.Pt(), el1.Eta(), mu1.Eta(), el1.Phi(), mu1.Phi(), (el1+mu1).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightElMu*bjet_weight);
                       h_TotalEvents_ElMu->Fill(8, eventWeightElMu*bjet_weight);
                       double mt1 = (mu1+v_met).Mt();
                       double mt2 = (el1+v_met).Mt();
                       double mtMax = std::max(mt1, mt2);
                       if(mtMax > 90.0)
                       {
                         cut9_elmu+=eventWeightElMu*bjet_weight;
                         fillElMuHistCollection(elmuHistCut12, el1.Pt(), mu1.Pt(), el1.Eta(), mu1.Eta(), el1.Phi(), mu1.Phi(), (el1+mu1).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightElMu*bjet_weight);
                         h_TotalEvents_ElMu->Fill(9, eventWeightElMu*bjet_weight);
                       }//mtmax > 90.0 
                    }//Mll > 40.0
                  }//met > 40.0 
                }//Leading invmass and delta eta
          ...
          {
            cutFatJet_elmu+=eventWeightElMu;
            if(v_selectedBJets.size()>0) bjet1pt = v_selectedBJets.at(0).JetLV.Pt();
            if(v_selectedBJets.size()>0) bjet1eta = v_selectedBJets.at(0).JetLV.Eta();
            if(v_selectedBJets.size()>0) bjet1phi = v_selectedBJets.at(0).JetLV.Phi();
            if(v_selectedBJets.size()>0) bjet1csv = v_selectedBJets.at(0).BTag_CSV;
            ...
            fatJetEta = v_fatJets.at(0).ak8JetEta;    
            fatJetPhi = v_fatJets.at(0).ak8JetPhi;  
            fillElMuHistCollectionWithFatJet(elmuHistFatJet, el1.Pt(), mu1.Pt(), el1.Eta(), mu1.Eta(), el1.Phi(), mu1.Phi(), (el1+mu1).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_fatJets.size(), jet1pt, jet2pt, jet1eta, jet2eta, jet1phi, jet2phi, bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, fatJetPt, fatJetEta, fatJetPhi, v_fatJets.at(0).ak8JetPrunmass, v_fatJets.at(0).ak8JetTrimmass, v_fatJets.at(0).ak8Jetsd0, (double)v_fatJets.at(0).ak8JetTau2/(double)v_fatJets.at(0).ak8JetTau1, eventWeightElMu);
            h_TotalEvents_ElMu->Fill(10, eventWeightElMu);
            if(v_fatJets.at(0).ak8JetPrunmass > 50 and v_fatJets.at(0).ak8JetPrunmass < 100) h_TotalEvents_ElMu->Fill(11, eventWeightElMu);
            if(v_fatJets.at(0).ak8JetTrimmass > 50 and v_fatJets.at(0).ak8JetTrimmass < 100) h_TotalEvents_ElMu->Fill(12, eventWeightElMu);
            if(v_fatJets.at(0).ak8Jetsd0 > 50 and v_fatJets.at(0).ak8Jetsd0 < 100) h_TotalEvents_ElMu->Fill(13, eventWeightElMu);
            if(v_fatJets.at(0).ak8Jetsd0 > 50 and (double)v_fatJets.at(0).ak8JetTau2/(double)v_fatJets.at(0).ak8JetTau1 < 0.6) h_TotalEvents_ElMu->Fill(14, eventWeightElMu);
            if(v_fatJets.at(0).ak8Jetsd0 > 70 and v_fatJets.at(0).ak8Jetsd0 < 90) h_TotalEvents_ElMu->Fill(15, eventWeightElMu); 
          }
        }//loose lepton veto
    ...
    else if(v_electrons.size() == 2 and v_muons.size()==0)
    {
        ...
        if(v_electrons.at(0).charge*v_electrons.at(1).charge==1 and v_electrons.at(0).pt > 30.0 and v_electrons.at(1).pt > 30.0)
        {
          ...
          if(v_looseElectrons.size()==0 and v_looseMuons.size()==0)
          {
            ...
            h_nfatJets_noCut_ElEl->Fill(v_fatJets.size(), eventWeightEl);
            if(v_selectedJets.size()>=2 and fabs(v_selectedJets.at(0).JetLV.Eta()) < 2.5 and fabs(v_selectedJets.at(1).JetLV.Eta()) < 2.5)
            {
              ...
              if(v_selectedBJets.size()==0)
              {
                cut4_elel+=eventWeightEl*bjet_weight;
                fillElHistCollection(elelHistCut4, el1.Pt(), el2.Pt(), el1.Eta(), el2.Eta(), el1.Phi(), el2.Phi(), (el1+el2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightEl*bjet_weight);
                double invMassLeadingJJ = (v_selectedJets.at(0).JetLV + v_selectedJets.at(1).JetLV).M();
                double deltaEta = fabs(v_selectedJets.at(0).JetLV.Eta()-v_selectedJets.at(1).JetLV.Eta());
                h_TotalEvents_ElEl->Fill(4, eventWeightEl*bjet_weight);
                if(invMassJJ > 60 and invMassJJ < 100)
                {
                  cut5_elel+=eventWeightEl*bjet_weight;
                  fillElHistCollection(elelHistCut5, el1.Pt(), el2.Pt(), el1.Eta(), el2.Eta(), el1.Phi(), el2.Phi(), (el1+el2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightEl*bjet_weight);
                  double invMassLeadingJJ = (v_selectedJets.at(0).JetLV + v_selectedJets.at(1).JetLV).M();
                  double deltaEta = fabs(v_selectedJets.at(0).JetLV.Eta()-v_selectedJets.at(1).JetLV.Eta());
                  h_TotalEvents_ElEl->Fill(5, eventWeightEl*bjet_weight);
                  if(invMassLeadingJJ < 400.0 and deltaEta < 1.5)
                  {
                    cut6_elel+=eventWeightEl*bjet_weight;
                    fillElHistCollection(elelHistCut6, el1.Pt(), el2.Pt(), el1.Eta(), el2.Eta(), el1.Phi(), el2.Phi(), (el1+el2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightEl*bjet_weight);
                    h_TotalEvents_ElEl->Fill(6, eventWeightEl*bjet_weight);
                    if(met > 40.0)
                    {
                      cut7_elel+=eventWeightEl*bjet_weight;
                      fillElHistCollection(elelHistCut7, el1.Pt(), el2.Pt(), el1.Eta(), el2.Eta(), el1.Phi(), el2.Phi(), (el1+el2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightEl*bjet_weight);
                      h_TotalEvents_ElEl->Fill(7, eventWeightEl*bjet_weight);
                      if((el1+el2).M() > 40.0)
                      {
                        cut8_elel+=eventWeightEl*bjet_weight;
                        fillElHistCollection(elelHistCut8, el1.Pt(), el2.Pt(), el1.Eta(), el2.Eta(), el1.Phi(), el2.Phi(), (el1+el2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_selectedJets.at(0).JetLV.Pt(), v_selectedJets.at(1).JetLV.Pt(), v_selectedJets.at(0).JetLV.Eta(), v_selectedJets.at(1).JetLV.Eta(), v_selectedJets.at(0).JetLV.Phi(), v_selectedJets.at(1).JetLV.Phi(), bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, eventWeightEl*bjet_weight);
                        h_TotalEvents_ElEl->Fill(8, eventWeightEl*bjet_weight);
                      }//Mll > 40.0
                    }//met > 40.0 
                  }//Leading invmass and delta eta
                }//closest invmass
            ...
            else if(v_fatJets.size() > 0 and v_fatJets.at(0).ak8JetPt > 180.0)
            {
              ...
              fatJetEta = v_fatJets.at(0).ak8JetEta;
              fatJetPhi = v_fatJets.at(0).ak8JetPhi;
              fillElHistCollectionWithFatJet(elelHistFatJet, el1.Pt(), el2.Pt(), el1.Eta(), el2.Eta(), el1.Phi(), el2.Phi(), (el1+el2).M(), met, v_selectedJets.size(), v_selectedBJets.size(), v_fatJets.size(), jet1pt, jet2pt, jet1eta, jet2eta, jet1phi, jet2phi, bjet1csv, bjet2csv, bjet1pt, bjet1eta, bjet1phi, bjet2pt, bjet2eta, bjet2phi, fatJetPt, fatJetEta, fatJetPhi, v_fatJets.at(0).ak8JetPrunmass, v_fatJets.at(0).ak8JetTrimmass, v_fatJets.at(0).ak8Jetsd0, (double)v_fatJets.at(0).ak8JetTau2/(double)v_fatJets.at(0).ak8JetTau1, eventWeightEl);
              h_TotalEvents_ElEl->Fill(10, eventWeightEl);
              if(v_fatJets.at(0).ak8JetPrunmass > 50 and v_fatJets.at(0).ak8JetPrunmass < 100) h_TotalEvents_ElEl->Fill(11, eventWeightEl);
              if(v_fatJets.at(0).ak8JetTrimmass > 50 and v_fatJets.at(0).ak8JetTrimmass < 100) h_TotalEvents_ElEl->Fill(12, eventWeightEl);
              if(v_fatJets.at(0).ak8Jetsd0 > 50 and v_fatJets.at(0).ak8Jetsd0 < 100) h_TotalEvents_ElEl->Fill(13, eventWeightEl);
              if(v_fatJets.at(0).ak8Jetsd0 > 50 and (double)v_fatJets.at(0).ak8JetTau2/(double)v_fatJets.at(0).ak8JetTau1 < 0.6) h_TotalEvents_ElEl->Fill(14, eventWeightEl);
              if(v_fatJets.at(0).ak8Jetsd0 > 70 and v_fatJets.at(0).ak8Jetsd0 < 90) h_TotalEvents_ElEl->Fill(15, eventWeightEl); 
           }
         }//loose lepton veto
  ...
  tFile->cd("2SSTLLVFatJet");
  writeHistCollection(mumuHistFatJet);
  writeHistCollection(elelHistFatJet);
  writeHistCollection(elmuHistFatJet);
  h_nfatJets_noCut_MuMu->Write();
  h_nfatJets_noCut_ElMu->Write();
  h_nfatJets_noCut_ElEl->Write();
  ...
  h_leading_mu_d0_WithIsoCut_MuMu->Write();
  h_trailing_mu_d0_WithIsoCut_MuMu->Write();
  h_leading_mu_dz_WithIsoCut_MuMu->Write();
  h_trailing_mu_dz_WithIsoCut_MuMu->Write();
  h_leading_mu_d0_WithIsoCut_ElMu->Write();
  h_leading_el_d0_WithIsoCut_ElMu->Write();
  h_leading_mu_dz_WithIsoCut_ElMu->Write();
  h_leading_el_dz_WithIsoCut_ElMu->Write();
  h_leading_el_d0_WithIsoCut_ElEl->Write();
  h_trailing_el_d0_WithIsoCut_ElEl->Write();
  h_leading_el_dz_WithIsoCut_ElEl->Write();
  h_trailing_el_dz_WithIsoCut_ElEl->Write();

  h_leading_mu_Iso_WithIpCut_MuMu->Write();
  h_trailing_mu_Iso_WithIpCut_MuMu->Write();
  h_leading_mu_Iso_WithIpCut_ElMu->Write();
  h_leading_el_Iso_WithIpCut_ElMu->Write();
  h_leading_el_Iso_WithIpCut_ElEl->Write();
  h_trailing_el_Iso_WithIpCut_ElEl->Write();
