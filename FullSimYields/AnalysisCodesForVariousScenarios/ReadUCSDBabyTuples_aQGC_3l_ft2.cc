...
int ReadUCSDBabyTuples_aQGC_3l_ft2(std::string infile, std::string treeStr, std::string type, std::string sample, std::string Trigger="None")
{
  ...
  */
  ...
  std::string histfilename=("output_"+infile+"_3l_ft2.root").c_str();
