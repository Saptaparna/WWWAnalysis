...
int ReadUCSDBabyTuples_aQGC_ft1(std::string infile, std::string treeStr, std::string type, std::string sample, std::string Trigger="None")
{
  ...
  TH1D *h_TotalEvents_MuMu_ST_SS_rwgt80 = new TH1D("h_TotalEvents_MuMu_ST_SS_rwgt80", "h_TotalEvents_MuMu_ST_SS_rwgt80", 15, -0.5, 14.5); h_TotalEvents_MuMu_ST_SS_rwgt80->Sumw2();
  TH1D *h_TotalEvents_MuMu_ST_SS_rwgt81 = new TH1D("h_TotalEvents_MuMu_ST_SS_rwgt81", "h_TotalEvents_MuMu_ST_SS_rwgt81", 15, -0.5, 14.5); h_TotalEvents_MuMu_ST_SS_rwgt81->Sumw2();  TH1D *h_TotalEvents_MuMu_ST_SS_rwgt82 = new TH1D("h_TotalEvents_MuMu_ST_SS_rwgt82", "h_TotalEvents_MuMu_ST_SS_rwgt82", 15, -0.5, 14.5); h_TotalEvents_MuMu_ST_SS_rwgt82->Sumw2();
  ...
  TH1D *h_TotalEvents_MuMu_ST_SS_rwgt88 = new TH1D("h_TotalEvents_MuMu_ST_SS_rwgt88", "h_TotalEvents_MuMu_ST_SS_rwgt88", 15, -0.5, 14.5); h_TotalEvents_MuMu_ST_SS_rwgt88->Sumw2();

  TH1D *h_TotalEvents_ElMu_ST_SS_rwgt78 = new TH1D("h_TotalEvents_ElMu_ST_SS_rwgt78", "h_TotalEvents_ElMu_ST_SS_rwgt78", 15, -0.5, 14.5); h_TotalEvents_ElMu_ST_SS_rwgt78->Sumw2();  TH1D *h_TotalEvents_ElMu_ST_SS_rwgt79 = new TH1D("h_TotalEvents_ElMu_ST_SS_rwgt79", "h_TotalEvents_ElMu_ST_SS_rwgt79", 15, -0.5, 14.5); h_TotalEvents_ElMu_ST_SS_rwgt79->Sumw2();
  TH1D *h_TotalEvents_ElMu_ST_SS_rwgt80 = new TH1D("h_TotalEvents_ElMu_ST_SS_rwgt80", "h_TotalEvents_ElMu_ST_SS_rwgt80", 15, -0.5, 14.5); h_TotalEvents_ElMu_ST_SS_rwgt80->Sumw2();
  TH1D *h_TotalEvents_ElMu_ST_SS_rwgt81 = new TH1D("h_TotalEvents_ElMu_ST_SS_rwgt81", "h_TotalEvents_ElMu_ST_SS_rwgt81", 15, -0.5, 14.5); h_TotalEvents_ElMu_ST_SS_rwgt81->Sumw2();  TH1D *h_TotalEvents_ElMu_ST_SS_rwgt82 = new TH1D("h_TotalEvents_ElMu_ST_SS_rwgt82", "h_TotalEvents_ElMu_ST_SS_rwgt82", 15, -0.5, 14.5); h_TotalEvents_ElMu_ST_SS_rwgt82->Sumw2();
  ...
  TH1D *h_TotalEvents_ElMu_ST_SS_rwgt88 = new TH1D("h_TotalEvents_ElMu_ST_SS_rwgt88", "h_TotalEvents_ElMu_ST_SS_rwgt88", 15, -0.5, 14.5); h_TotalEvents_ElMu_ST_SS_rwgt88->Sumw2();

  TH1D *h_TotalEvents_ElEl_ST_SS_rwgt78 = new TH1D("h_TotalEvents_ElEl_ST_SS_rwgt78", "h_TotalEvents_ElEl_ST_SS_rwgt78", 15, -0.5, 14.5); h_TotalEvents_ElEl_ST_SS_rwgt78->Sumw2();  TH1D *h_TotalEvents_ElEl_ST_SS_rwgt79 = new TH1D("h_TotalEvents_ElEl_ST_SS_rwgt79", "h_TotalEvents_ElEl_ST_SS_rwgt79", 15, -0.5, 14.5); h_TotalEvents_ElEl_ST_SS_rwgt79->Sumw2();
  TH1D *h_TotalEvents_ElEl_ST_SS_rwgt80 = new TH1D("h_TotalEvents_ElEl_ST_SS_rwgt80", "h_TotalEvents_ElEl_ST_SS_rwgt80", 15, -0.5, 14.5); h_TotalEvents_ElEl_ST_SS_rwgt80->Sumw2();
  TH1D *h_TotalEvents_ElEl_ST_SS_rwgt81 = new TH1D("h_TotalEvents_ElEl_ST_SS_rwgt81", "h_TotalEvents_ElEl_ST_SS_rwgt81", 15, -0.5, 14.5); h_TotalEvents_ElEl_ST_SS_rwgt81->Sumw2();  TH1D *h_TotalEvents_ElEl_ST_SS_rwgt82 = new TH1D("h_TotalEvents_ElEl_ST_SS_rwgt82", "h_TotalEvents_ElEl_ST_SS_rwgt82", 15, -0.5, 14.5); h_TotalEvents_ElEl_ST_SS_rwgt82->Sumw2();
  ...
  TH1D *h_TotalEvents_ElEl_ST_SS_rwgt88 = new TH1D("h_TotalEvents_ElEl_ST_SS_rwgt88", "h_TotalEvents_ElEl_ST_SS_rwgt88", 15, -0.5, 14.5); h_TotalEvents_ElEl_ST_SS_rwgt88->Sumw2();
  ...
  TH1D *h_ST_rwgt88 = new TH1D("h_ST_rwgt88", "h_ST_rwgt88", 100, 0.0, 5000.0); h_ST_rwgt88->Sumw2();
              ...
              if(DetajjL < 1.5 and MllSS > 40 and met_pt > 60)
              {
                if(sample=="aQGC") 
                {
                  for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                  {
                    ...
                    if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_MuMu_ST_SS_rwgt88->Fill(1, genWeight);  
                  }
                } 
                ...
                if(ST > 250)
                {
                  if(sample=="aQGC") 
                  {
                    for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                    {
                      ...
                      if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_MuMu_ST_SS_rwgt88->Fill(2, genWeight);
                    }
                  }
                  ...
                  if(ST > 500)
                  {
                    if(sample=="aQGC")
                    {
                      for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                      {
                        ...
                        if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_MuMu_ST_SS_rwgt88->Fill(3, genWeight);
                      }
                    }
                    ...
                    { 
                      if(sample=="aQGC")
                      {
                        for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                        {
                          ...
                          if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_MuMu_ST_SS_rwgt88->Fill(4, genWeight);
                        }
                      } 
                      ...
                      if(ST > 1000)
                      {
                        if(sample=="aQGC")
                        {
                          for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                          {
                            ...
                            if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_MuMu_ST_SS_rwgt88->Fill(5, genWeight);
                          }
                        } 
                        ...
                        if(ST > 1500)
                        {
                          if(sample=="aQGC")
                          {
                            for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                            {
                              ...
                              if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_MuMu_ST_SS_rwgt88->Fill(6, genWeight);
                            }
                          }
                          ...
                          if(ST > 2000)
                          {
                            if(sample=="aQGC")
                            {
                              for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                              {
                                ...
                                if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_MuMu_ST_SS_rwgt88->Fill(7, genWeight);
                              }
                            }
                            ...
                            if(ST > 2500)
                            {
                              if(sample=="aQGC")
                              {
                                for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                                {
                                  ...
                                  if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_MuMu_ST_SS_rwgt88->Fill(8, genWeight);
                                }
                              }
              ...
              if(DetajjL < 1.5 and MllSS > 30 and met_pt > 60 and MTmax > 90.0)
              {
                if(sample=="aQGC")
                {
                  for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                  {
                    ...
                    if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElMu_ST_SS_rwgt88->Fill(1, genWeight);
                  }
                }
                ...
                if(ST > 250)
                {
                  if(sample=="aQGC")
                  {
                    for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                    {
                      ...
                      if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElMu_ST_SS_rwgt88->Fill(2, genWeight);
                    }
                  }
                  ...
                  if(ST > 500)
                  {
                    if(sample=="aQGC")
                    {
                      for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                      {
                        ...
                        if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElMu_ST_SS_rwgt88->Fill(3, genWeight);
                      }
                    }
                    ...
                    if(ST > 750)
                    {
                      if(sample=="aQGC")
                      {
                        for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                        {
                          ...
                          if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElMu_ST_SS_rwgt88->Fill(4, genWeight);
                        }
                      }
                      ...
                      if(ST > 1000)
                      {
                        if(sample=="aQGC")
                        {
                          for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                          {
                            ...
                            if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElMu_ST_SS_rwgt88->Fill(5, genWeight);
                          }
                        }
                        ...
                        if(ST > 1500)
                        {
                          if(sample=="aQGC")
                          {
                            for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                            {
                              ...
                              if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElMu_ST_SS_rwgt88->Fill(6, genWeight);
                            }
                          }
                          ...
                          if(ST > 2000)
                          {
                            if(sample=="aQGC")
                            {
                              for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                              {
                                ...
                                if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElMu_ST_SS_rwgt88->Fill(7, genWeight);
                              }
                            }
                            ...
                            if(ST > 2500)
                            {
                              if(sample=="aQGC")
                              {
                                for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                                {
                                  ...
                                  if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElMu_ST_SS_rwgt88->Fill(8, genWeight);
                                }
                              }
              ...
              if(DetajjL < 1.5 and MllSS > 40 and met_pt > 60 and abs(MllSS-91.1876)>10.0)
              {
                if(sample=="aQGC")
                {
                  for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                  {
                    ...
                    if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElEl_ST_SS_rwgt88->Fill(1, genWeight);
                  }
                }
                ...
                if(ST > 250)
                {
                  if(sample=="aQGC")
                  {
                    for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                    {
                      ...
                      if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElEl_ST_SS_rwgt88->Fill(2, genWeight);
                    }
                  } 
                  ...
                  if(ST > 500)
                  {
                    if(sample=="aQGC")
                    {
                      for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                      {
                        ...
                        if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElEl_ST_SS_rwgt88->Fill(3, genWeight);
                      }
                    }
                    ...
                    if(ST > 750)
                    {
                      if(sample=="aQGC")
                      {
                        for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                        {
                          ...
                          if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElEl_ST_SS_rwgt88->Fill(4, genWeight);
                        }
                      } 
                      ...
                      { 
                        if(sample=="aQGC")
                        {
                          for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                          {
                            ...
                            if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElEl_ST_SS_rwgt88->Fill(5, genWeight);
                          }
                        } 
                        ...
                        if(ST > 1500)
                        {
                          if(sample=="aQGC")
                          {
                            for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                            {
                              ...
                              if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElEl_ST_SS_rwgt88->Fill(6, genWeight);
                            }
                          } 
                          ...
                          if(ST > 2000)
                          {
                            if(sample=="aQGC")
                            {
                              for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                              {
                                ...
                                if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElEl_ST_SS_rwgt88->Fill(7, genWeight);
                              }
                            } 
                            ...
                            if(ST > 2500)
                            {
                              if(sample=="aQGC")
                              {
                                for(unsigned int ig=0; ig<v_genweights.size(); ig++)
                                {
                                  ...
                                  if(v_genweights.at(ig).genWeightID=="rwgt_88") h_TotalEvents_ElEl_ST_SS_rwgt88->Fill(8, genWeight);
                                }
                              } 
  ...
  std::string histfilename=("output_"+infile+"_ft1.root").c_str();
  ...
  h_TotalEvents_MuMu_ST_SS_rwgt88->Write();
  ...
  h_TotalEvents_ElMu_ST_SS_rwgt88->Write();
  ...
  h_TotalEvents_ElEl_ST_SS_rwgt88->Write();
  tFile->Close();
  inputFile->Close();
