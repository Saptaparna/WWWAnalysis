...
void getYieldsPerCutLevel_0SFOS_noST()
{
  ...
  TFile* fileTTW = new TFile("output_ttw_incl_mgmlm_skim_1_1_3l.root");
  TH1F *hTTW_0SFOS = (TH1F*)fileTTW->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileTTZ = new TFile("output_ttz_incl_mgmlm_skim_1_1_3l.root");
  TH1F *hTTZ_0SFOS = (TH1F*)fileTTZ->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileTTbar1 = new TFile("output_ttbar_1ltbr_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hTTbar1_0SFOS = (TH1F*)fileTTbar1->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileTTbar2 = new TFile("output_ttbar_1ltop_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hTTbar2_0SFOS = (TH1F*)fileTTbar2->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileTTbar3 = new TFile("output_ttbar_dilep_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hTTbar3_0SFOS = (TH1F*)fileTTbar3->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileDY1050 = new TFile("output_dy_m1050_mgmlm_skim_1_1_3l.root");
  TH1F *hDY1050_0SFOS = (TH1F*)fileDY1050->Get("h_TotalEvents_0SFOS_ST");
  
  TFile* fileDY50 = new TFile("output_dy_m50_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hDY50_0SFOS = (TH1F*)fileDY50->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileWJets1 = new TFile("output_wjets_ht100_mgmlm_ext1_skim_1_1_3l.root"); 
  TH1F *hWJets1_0SFOS = (TH1F*)fileWJets1->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileWJets2 = new TFile("output_wjets_ht200_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hWJets2_0SFOS = (TH1F*)fileWJets2->Get("h_TotalEvents_0SFOS_ST");
  
  TFile* fileWJets3 = new TFile("output_wjets_ht400_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hWJets3_0SFOS = (TH1F*)fileWJets3->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileWJets4 = new TFile("output_wjets_ht600_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hWJets4_0SFOS = (TH1F*)fileWJets4->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileWJets5 = new TFile("output_wjets_ht800_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hWJets5_0SFOS = (TH1F*)fileWJets5->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileWJets6 = new TFile("output_wjets_ht1200_mgmlm_nonext_skim_1_1_3l.root");
  TH1F *hWJets6_0SFOS = (TH1F*)fileWJets6->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileWJets7 = new TFile("output_wjets_ht2500_mgmlm_ext1_skim_1_1_3l.root");
  TH1F *hWJets7_0SFOS = (TH1F*)fileWJets7->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileWWJJ = new TFile("output_wpwpjj_ewk-qcd_madgraph_skim_1_1_3l.root"); 
  TH1F *hWWJJ_0SFOS = (TH1F*)fileWWJJ->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileZZ1 = new TFile("output_zz_2l2n_powheg_skim_1_1_3l.root");
  TH1F *hZZ1_0SFOS = (TH1F*)fileZZ1->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileZZ2 = new TFile("output_zz_2l2q_powheg_skim_1_1_3l.root");
  TH1F *hZZ2_0SFOS = (TH1F*)fileZZ2->Get("h_TotalEvents_0SFOS_ST");

  TFile* fileZZ3 = new TFile("output_zz_4l_powheg_skim_1_1_3l.root");
  TH1F *hZZ3_0SFOS = (TH1F*)fileZZ3->Get("h_TotalEvents_0SFOS_ST");
 
  TFile* fileWZ = new TFile("output_wz_3lnu_powheg_skim_1_1_3l.root");
  TH1F *hWZ_0SFOS = (TH1F*)fileWZ->Get("h_TotalEvents_0SFOS_ST");

  TFile *fileSignal = new TFile("output_www_2l_ext1_mia_skim_1_1_3l.root");
...
void getYieldsPerCutLevel_0SFOS_ST1500()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_0SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_0SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_0SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_0SFOS->GetBinContent(7)*LUMI + hZZ2_0SFOS->GetBinContent(7)*LUMI + hZZ3_0SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_0SFOS->GetBinContent(7)*LUMI + hWJets2_0SFOS->GetBinContent(7)*LUMI + hWJets3_0SFOS->GetBinContent(7)*LUMI + hWJets4_0SFOS->GetBinContent(7)*LUMI + hWJets5_0SFOS->GetBinContent(7)*LUMI + hWJets6_0SFOS->GetBinContent(7)*LUMI + hWJets7_0SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_0SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"       << " & "   << hTTbar1_0SFOS->GetBinContent(7)*LUMI + hTTbar2_0SFOS->GetBinContent(7)*LUMI + hTTbar3_0SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_0SFOS->GetBinContent(7)*LUMI + hDY50_0SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
...
void getYieldsPerCutLevel_0SFOS_ST2000()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_0SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_0SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_0SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_0SFOS->GetBinContent(8)*LUMI + hZZ2_0SFOS->GetBinContent(8)*LUMI + hZZ3_0SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_0SFOS->GetBinContent(8)*LUMI + hWJets2_0SFOS->GetBinContent(8)*LUMI + hWJets3_0SFOS->GetBinContent(8)*LUMI + hWJets4_0SFOS->GetBinContent(8)*LUMI + hWJets5_0SFOS->GetBinContent(8)*LUMI + hWJets6_0SFOS->GetBinContent(8)*LUMI + hWJets7_0SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_0SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"         << " & "   << hTTbar1_0SFOS->GetBinContent(8)*LUMI + hTTbar2_0SFOS->GetBinContent(8)*LUMI + hTTbar3_0SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_0SFOS->GetBinContent(8)*LUMI + hDY50_0SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
...
void getYieldsPerCutLevel_0SFOS_ST2500()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_0SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_0SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_0SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_0SFOS->GetBinContent(9)*LUMI + hZZ2_0SFOS->GetBinContent(9)*LUMI + hZZ3_0SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_0SFOS->GetBinContent(9)*LUMI + hWJets2_0SFOS->GetBinContent(9)*LUMI + hWJets3_0SFOS->GetBinContent(9)*LUMI + hWJets4_0SFOS->GetBinContent(9)*LUMI + hWJets5_0SFOS->GetBinContent(9)*LUMI + hWJets6_0SFOS->GetBinContent(9)*LUMI + hWJets7_0SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_0SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"         << " & "   << hTTbar1_0SFOS->GetBinContent(9)*LUMI + hTTbar2_0SFOS->GetBinContent(9)*LUMI + hTTbar3_0SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_0SFOS->GetBinContent(9)*LUMI + hDY50_0SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
...
void getYieldsPerCutLevel_1SFOS_ST1500()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_1SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_1SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_1SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_1SFOS->GetBinContent(7)*LUMI + hZZ2_1SFOS->GetBinContent(7)*LUMI + hZZ3_1SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_1SFOS->GetBinContent(7)*LUMI + hWJets2_1SFOS->GetBinContent(7)*LUMI + hWJets3_1SFOS->GetBinContent(7)*LUMI + hWJets4_1SFOS->GetBinContent(7)*LUMI + hWJets5_1SFOS->GetBinContent(7)*LUMI + hWJets6_1SFOS->GetBinContent(7)*LUMI + hWJets7_1SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_1SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"       << " & "   << hTTbar1_1SFOS->GetBinContent(7)*LUMI + hTTbar2_1SFOS->GetBinContent(7)*LUMI + hTTbar3_1SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_1SFOS->GetBinContent(7)*LUMI + hDY50_1SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
...
void getYieldsPerCutLevel_1SFOS_ST2000()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_1SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_1SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_1SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_1SFOS->GetBinContent(8)*LUMI + hZZ2_1SFOS->GetBinContent(8)*LUMI + hZZ3_1SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_1SFOS->GetBinContent(8)*LUMI + hWJets2_1SFOS->GetBinContent(8)*LUMI + hWJets3_1SFOS->GetBinContent(8)*LUMI + hWJets4_1SFOS->GetBinContent(8)*LUMI + hWJets5_1SFOS->GetBinContent(8)*LUMI + hWJets6_1SFOS->GetBinContent(8)*LUMI + hWJets7_1SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_1SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"         << " & "   << hTTbar1_1SFOS->GetBinContent(8)*LUMI + hTTbar2_1SFOS->GetBinContent(8)*LUMI + hTTbar3_1SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_1SFOS->GetBinContent(8)*LUMI + hDY50_1SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
...
void getYieldsPerCutLevel_1SFOS_ST2500()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_1SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_1SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_1SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_1SFOS->GetBinContent(9)*LUMI + hZZ2_1SFOS->GetBinContent(9)*LUMI + hZZ3_1SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_1SFOS->GetBinContent(9)*LUMI + hWJets2_1SFOS->GetBinContent(9)*LUMI + hWJets3_1SFOS->GetBinContent(9)*LUMI + hWJets4_1SFOS->GetBinContent(9)*LUMI + hWJets5_1SFOS->GetBinContent(9)*LUMI + hWJets6_1SFOS->GetBinContent(9)*LUMI + hWJets7_1SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_1SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"         << " & "   << hTTbar1_1SFOS->GetBinContent(9)*LUMI + hTTbar2_1SFOS->GetBinContent(9)*LUMI + hTTbar3_1SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_1SFOS->GetBinContent(9)*LUMI + hDY50_1SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
...
void getYieldsPerCutLevel_2SFOS_ST1500()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_2SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_2SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_2SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_2SFOS->GetBinContent(7)*LUMI + hZZ2_2SFOS->GetBinContent(7)*LUMI + hZZ3_2SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_2SFOS->GetBinContent(7)*LUMI + hWJets2_2SFOS->GetBinContent(7)*LUMI + hWJets3_2SFOS->GetBinContent(7)*LUMI + hWJets4_2SFOS->GetBinContent(7)*LUMI + hWJets5_2SFOS->GetBinContent(7)*LUMI + hWJets6_2SFOS->GetBinContent(7)*LUMI + hWJets7_2SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_2SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"       << " & "   << hTTbar1_2SFOS->GetBinContent(7)*LUMI + hTTbar2_2SFOS->GetBinContent(7)*LUMI + hTTbar3_2SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_2SFOS->GetBinContent(7)*LUMI + hDY50_2SFOS->GetBinContent(7)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
...
void getYieldsPerCutLevel_2SFOS_ST2000()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_2SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_2SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_2SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_2SFOS->GetBinContent(8)*LUMI + hZZ2_2SFOS->GetBinContent(8)*LUMI + hZZ3_2SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_2SFOS->GetBinContent(8)*LUMI + hWJets2_2SFOS->GetBinContent(8)*LUMI + hWJets3_2SFOS->GetBinContent(8)*LUMI + hWJets4_2SFOS->GetBinContent(8)*LUMI + hWJets5_2SFOS->GetBinContent(8)*LUMI + hWJets6_2SFOS->GetBinContent(8)*LUMI + hWJets7_2SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_2SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"         << " & "   << hTTbar1_2SFOS->GetBinContent(8)*LUMI + hTTbar2_2SFOS->GetBinContent(8)*LUMI + hTTbar3_2SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_2SFOS->GetBinContent(8)*LUMI + hDY50_2SFOS->GetBinContent(8)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
...
void getYieldsPerCutLevel_2SFOS_ST2500()
{
    ...
    std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
    std::cout << "\\hline" << std::endl;
    std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_2SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_2SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(2) << hTTZ_2SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$ZZ$"              << " & "   << std::setprecision(2) << hZZ1_2SFOS->GetBinContent(9)*LUMI + hZZ2_2SFOS->GetBinContent(9)*LUMI + hZZ3_2SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "W+jets"            << " & "   << std::setprecision(2) << hWJets1_2SFOS->GetBinContent(9)*LUMI + hWJets2_2SFOS->GetBinContent(9)*LUMI + hWJets3_2SFOS->GetBinContent(9)*LUMI + hWJets4_2SFOS->GetBinContent(9)*LUMI + hWJets5_2SFOS->GetBinContent(9)*LUMI + hWJets6_2SFOS->GetBinContent(9)*LUMI + hWJets7_2SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "WW"                << " & "   << hWWJJ_2SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "$t\\bar{t}$"         << " & "   << hTTbar1_2SFOS->GetBinContent(9)*LUMI + hTTbar2_2SFOS->GetBinContent(9)*LUMI + hTTbar3_2SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "DY"                << " & "   << hDY1050_2SFOS->GetBinContent(9)*LUMI + hDY50_2SFOS->GetBinContent(9)*LUMI << " \\\\ " << std::endl;
    std::cout << "\\hline\\hline" << std::endl;
