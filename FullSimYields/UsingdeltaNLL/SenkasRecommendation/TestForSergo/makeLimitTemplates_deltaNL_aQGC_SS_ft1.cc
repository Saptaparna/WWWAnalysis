...
int makeLimitTemplates_deltaNL_aQGC_SS_ft1(std::string outfile)
{
...
int makeLimitTemplates_deltaNL_aQGC_SS_signal_ft1(std::string outfile)
{
  ...
  double yield2 = 0.351;
  double yield3 = 0.198;
  double yield4 = 0.08696;
  double yield5 = 0.0251;
  double yield6 = 0.00498;
  double yield7 = 0.0291;
  double yield8 = 0.0975;
  double yield9 = 0.21;
  double yield10 = 0.367;
  double yield11 = 0.568;
