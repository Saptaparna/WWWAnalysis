...
int makeLimitTemplates_deltaNL_aQGC_SS_ft2(std::string outfile)
{
...
int makeLimitTemplates_deltaNL_aQGC_SS_signal_ft2(std::string outfile)
{
  ...
  double yield3 = 0.296;
  double yield4 = 0.132;
  double yield5 = 0.0348;
  double yield6 = 0.00498;
  double yield7 = 0.0423;
  double yield8 = 0.147;
  double yield9 = 0.318;
  double yield10 = 0.557;
  double yield11 = 0.863;
  ...
  gr->SetTitle("");
  gr->SetTitle("Param (ft2) Vs Yield");
  gr->GetXaxis()->SetTitle("Param (ft2)");
  ...
  c1.SaveAs("Parabola_ft2_ST2000_SS.pdf");
  c1.SaveAs("Parabola_ft2_ST2000_SS.png");
