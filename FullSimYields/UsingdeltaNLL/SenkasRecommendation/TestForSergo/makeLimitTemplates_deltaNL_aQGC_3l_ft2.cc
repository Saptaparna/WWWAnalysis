...
int makeLimitTemplates_deltaNL_aQGC_3l_ft2(std::string outfile)
{
...
int makeLimitTemplates_deltaNL_aQGC_3l_signal_ft2(std::string outfile)
{
  ...
  double yield3 = 0.317;
  double yield4 = 0.144;
  double yield5 = 0.0419;
  double yield6 = 0.00985;
  double yield7 = 0.0482;
  double yield8 = 0.157;
  double yield9 = 0.336;
  double yield10 = 0.585;
  double yield11 = 0.905;
  ...
  c1.SaveAs("Parabola_ft2_ST1500.pdf");
  c1.SaveAs("Parabola_ft2_ST1500.png");
