...
int ReadUCSDBabyTuples_3l(std::string infile, std::string treeStr, std::string Sample, std::string trig, std::string Trigger="None")
{
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    if((nVlep==3)*(nLlep==3)*(nTlep==3))
    {
      ...
      if(lep_pt->at(0) > 25. and lep_pt->at(1) > 20. and lep_pt->at(2) > 20. and nSFOS==0 and nj<=1 and nb==0 and DPhi3lMET>2.5 and met_pt>30.0 and Mll3L > 20. and abs(M3l-91.1876) > 15. and abs(Mee3L-91.1876) > 15. and MTmax3L > 90.0) n_events_nSFOS++;
      //if(lep_pt->at(0) > 25. and lep_pt->at(1) > 20. and lep_pt->at(2) > 20. and nSFOS==0 and nj<=1 and nb==0 and DPhi3lMET>2.5 and met_pt>30.0 and Mll3L > 20. and abs(M3l-91.1876) > 15. and abs(Mee3L-91.1876) > 15. and MTmax3L > 90.0) std::cout << "event = " << evt << " run = " << run << " lumi " << lumi << std::endl;
      if(lep_pt->at(0) > 25. and nSFOS==1 and nj<=1 and nb==0 and Pt3l>60.0 and DPhi3lMET>2.5 and met_pt>40.0 and Mll3L > 20. and abs(M3l-91.1876) > 10. and nSFOSinZ==0 and MT3rd > 90.0) n_events_nSFOS1++;
      if(lep_pt->at(0) > 25. and nSFOS==1 and nj<=1 and nb==0 and Pt3l>60.0 and DPhi3lMET>2.5 and met_pt>40.0 and Mll3L > 20. and abs(M3l-91.1876) > 10. and nSFOSinZ==0 and MT3rd > 90.0) std::cout << "event = " << evt << " run = " << run << " lumi " << lumi << std::endl;
      if(lep_pt->at(0) > 25. and nSFOS==2 and nj<=1 and nb==0 and Pt3l>60.0 and DPhi3lMET>2.5 and met_pt>55.0 and (Mll3L > 20. && Mll3L1 > 20.)and abs(M3l-91.1876) > 10. and nSFOSinZ == 0) n_events_nSFOS2++;
      //std::cout << "mc_HLT_DoubleEl = " << mc_HLT_DoubleEl << std::endl;
      //std::cout << "mc_HLT_MuEG = " << mc_HLT_MuEG << std::endl;
      //std::cout << "mc_HLT_DoubleMu = " << mc_HLT_DoubleMu << std::endl;
    }
    if(debug)
    {
