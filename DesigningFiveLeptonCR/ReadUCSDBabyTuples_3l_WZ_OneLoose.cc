...
int ReadUCSDBabyTuples_3l_WZ_OneLoose(std::string infile, std::string treeStr, std::string Sample, std::string Trigger="None")
{
  ...
  HistCollection Cut3_2Mu2El_LooseEl;//z-tag
  initializeHistCollection(Cut3_2Mu2El_LooseEl, "Cut3_2Mu2El_LooseEl");

  HistCollection Cut4_2Mu2El_LooseEl;//MET > 40
  initializeHistCollection(Cut4_2Mu2El_LooseEl, "Cut4_2Mu2El_LooseEl");
  ...
  HistCollection Cut3_2Mu2El_LooseMu;//z-tag
  initializeHistCollection(Cut3_2Mu2El_LooseMu, "Cut3_2Mu2El_LooseMu");

  HistCollection Cut4_2Mu2El_LooseMu;//MET > 40
  initializeHistCollection(Cut4_2Mu2El_LooseMu, "Cut4_2Mu2El_LooseMu"); 
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    if(v_muons.size()==3 and v_electrons.size()==1 and v_muons.at(0).iso < 0.25 and v_muons.at(1).iso < 0.25 and v_muons.at(2).iso < 0.25 and (elecIsoCut(v_electrons.at(0).eta, v_electrons.at(0).pt, v_electrons.at(0).iso)==false))
    {
      ...
      if(nb==0)
      {
        ...
        if(fabs((v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M() - 91.1875) < 10 or fabs((v_muons.at(1).lep_lv+v_muons.at(2).lep_lv).M() - 91.1875) < 10 or fabs((v_muons.at(0).lep_lv+v_muons.at(2).lep_lv).M() - 91.1875) < 10)
        {
          ...
          if(v_electrons.at(0).lep_lv.Pt() > 25.0 and v_muons.at(0).lep_lv.Pt() > 10.0 and v_muons.at(1).lep_lv.Pt() > 10.0)
    ...
    { 
      ...
      if(nb==0)
      {
        ...
        {
          fillElMuHistCollection4l(Cut3_2Mu2El_LooseMu, v_electrons.at(0).pt, 0.0, v_muons.at(0).pt, v_muons.at(1).pt, v_electrons.at(0).eta, 0.0, v_muons.at(0).eta, v_muons.at(1).eta, v_electrons.at(0).phi, 0.0, v_muons.at(0).phi, v_muons.at(1).phi, v_electrons.at(0).sip3d, 0.0, v_muons.at(0).sip3d, v_muons.at(1).sip3d, v_electrons.at(0).dxy, 0.0, v_muons.at(0).dxy, v_muons.at(1).dxy, v_electrons.at(0).dz, 0.0, v_muons.at(0).dz, v_muons.at(1).dz, v_electrons.at(0).iso, 0.0, v_muons.at(0).iso, v_muons.at(1).iso, met_pt, nj, nb, nlep, 0.0, 0.0, (v_electrons.at(0).lep_lv+v_muons.at(0).lep_lv).M(), (v_electrons.at(0).lep_lv).M(), (v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M(), weight);
          h_TotalEvents_1El2Mu->Fill(3, weight);
          if(met_pt > 30.0 and (v_electrons.at(0).lep_lv+v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M() > 100.0 and v_electrons.at(0).lep_lv.Pt() > 25.0 and v_muons.at(0).lep_lv.Pt() > 25.0 and v_muons.at(1).lep_lv.Pt() > 10.0 and v_electrons.at(1).lep_lv.Pt() > 10.0)
          {
            ...
            fillElMuHistCollection4l(Cut4_2Mu2El_LooseMu, v_electrons.at(0).pt, 0.0, v_muons.at(0).pt, v_muons.at(1).pt, v_electrons.at(0).eta, 0.0, v_muons.at(0).eta, v_muons.at(1).eta, v_electrons.at(0).phi, 0.0, v_muons.at(0).phi, v_muons.at(1).phi, v_electrons.at(0).sip3d, 0.0, v_muons.at(0).sip3d, v_muons.at(1).sip3d, v_electrons.at(0).dxy, 0.0, v_muons.at(0).dxy, v_muons.at(1).dxy, v_electrons.at(0).dz, 0.0, v_muons.at(0).dz, v_muons.at(1).dz, v_electrons.at(0).iso, 0.0, v_muons.at(0).iso, v_muons.at(1).iso, met_pt, nj, nb, nlep, 0.0, 0.0, mt1, mt2, (v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M(), weight);
            h_TotalEvents_1El2Mu->Fill(4, weight);
          }//met cut
        }//z-tag
      }//b-tag
    ...
    if(v_muons.size()==2 and v_electrons.size()==2 and v_muons.at(0).iso < 0.25 and v_muons.at(1).iso < 0.25 and (elecIsoCut(v_electrons.at(0).eta, v_electrons.at(0).pt, v_electrons.at(0).iso)==true) and (elecIsoCut(v_electrons.at(1).eta, v_electrons.at(1).pt, v_electrons.at(1).iso)==false))
    {
      ...
      if(nb==0)
      {
        ...
        {
          fillElMuHistCollection4l(Cut3_2Mu2El_LooseEl, v_electrons.at(0).pt, 0.0, v_muons.at(0).pt, v_muons.at(1).pt, v_electrons.at(0).eta, 0.0, v_muons.at(0).eta, v_muons.at(1).eta, v_electrons.at(0).phi, 0.0, v_muons.at(0).phi, v_muons.at(1).phi, v_electrons.at(0).sip3d, 0.0, v_muons.at(0).sip3d, v_muons.at(1).sip3d, v_electrons.at(0).dxy, 0.0, v_muons.at(0).dxy, v_muons.at(1).dxy, v_electrons.at(0).dz, 0.0, v_muons.at(0).dz, v_muons.at(1).dz, v_electrons.at(0).iso, 0.0, v_muons.at(0).iso, v_muons.at(1).iso, met_pt, nj, nb, nlep, 0.0, 0.0, (v_electrons.at(0).lep_lv+v_muons.at(0).lep_lv).M(), (v_electrons.at(0).lep_lv).M(), (v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M(), weight);
          h_TotalEvents_1El2Mu->Fill(3, weight);
          if(met_pt > 30.0 and (v_electrons.at(0).lep_lv+v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M() > 100.0 and v_electrons.at(0).lep_lv.Pt() > 25.0 and v_muons.at(0).lep_lv.Pt() > 25.0 and v_muons.at(1).lep_lv.Pt() > 10.0 and v_electrons.at(1).lep_lv.Pt() > 10.0)
          {
            double mt1 = sqrt(2*met_pt*v_electrons.at(0).lep_lv.Pt()*(1.0 - cos(v_electrons.at(0).lep_lv.Phi() - met_phi)));
...
*/
  ...
  tFile->cd();
  tFile->mkdir("Cut3_2Mu2El_LooseMu");
  tFile->cd("Cut3_2Mu2El_LooseMu");
  writeHistCollection(Cut3_2Mu2El_LooseMu);
  tFile->cd();
  tFile->mkdir("Cut4_2Mu2El_LooseMu");
  tFile->cd("Cut4_2Mu2El_LooseMu");
  writeHistCollection(Cut4_2Mu2El_LooseMu);
  tFile->cd();
  ...
  tFile->cd();
  tFile->mkdir("Cut3_2Mu2El_LooseEl");
  tFile->cd("Cut3_2Mu2El_LooseEl");
  writeHistCollection(Cut3_2Mu2El_LooseEl);
  tFile->cd();
  tFile->mkdir("Cut4_2Mu2El_LooseEl");
  tFile->cd("Cut4_2Mu2El_LooseEl");
  writeHistCollection(Cut4_2Mu2El_LooseEl);
  tFile->cd();
  h_zmass_1->Write();
  h_zmass_2->Write();
  h_mT->Write();
