...
int ReadUCSDBabyTuples_new_4l_CR_OneLoose(std::string infile, std::string treeStr, std::string Sample, std::string Trigger="None")
{
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    //if(v_leptons.size() < 4) continue;


    if(v_muons.size()==4 and v_muons.at(0).iso < 0.25 and v_muons.at(1).iso < 0.25 and v_muons.at(2).iso < 0.25 and v_muons.at(3).iso > 0.25)//only loosen isolation of the lowest pT muon
    {
      weight *= v_muons.at(0).sf*v_muons.at(1).sf*v_muons.at(2).sf*v_muons.at(3).sf;
      h_4mupT->Fill((v_muons.at(0).lep_lv+v_muons.at(1).lep_lv+v_muons.at(2).lep_lv+v_muons.at(3).lep_lv).Pt());
      ...
      if(nb==0 and lep_zcand_idx1 >= 0 and lep_zcand_idx2 >= 0)//tagged one z
      {
        ...
        else if(Sample=="Data") 
        {
          ...
          fillMuHistCollection4l(Cut1_4l, v_muons.at(0).pt, v_muons.at(1).pt, v_muons.at(2).pt, v_muons.at(3).pt, v_muons.at(0).eta, v_muons.at(1).eta, v_muons.at(2).eta, v_muons.at(3).eta, v_muons.at(0).phi, v_muons.at(1).phi, v_muons.at(2).phi, v_muons.at(3).phi, v_muons.at(0).sip3d, v_muons.at(1).sip3d, v_muons.at(2).sip3d, v_muons.at(3).sip3d, v_muons.at(0).dxy, v_muons.at(1).dxy, v_muons.at(2).dxy, v_muons.at(3).dxy, v_muons.at(0).dz, v_muons.at(1).dz, v_muons.at(2).dz, v_muons.at(3).dz, v_muons.at(0).iso, v_muons.at(1).iso, v_muons.at(2).iso, v_muons.at(3).iso, met_pt, nj, nb, (v_muons.at(0).lep_lv+v_muons.at(1).lep_lv+v_muons.at(2).lep_lv+v_muons.at(3).lep_lv).M(), (v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M(), (v_muons.at(1).lep_lv+v_muons.at(2).lep_lv).M(), (v_muons.at(2).lep_lv+v_muons.at(3).lep_lv).M(), (v_muons.at(3).lep_lv+v_muons.at(0).lep_lv).M(), 1.0);
    ...
    else if(v_electrons.size()==4 and (elecIsoCut(v_electrons.at(0).eta, v_electrons.at(0).pt, v_electrons.at(0).iso)==true) and (elecIsoCut(v_electrons.at(1).eta, v_electrons.at(1).pt, v_electrons.at(1).iso)==true) and (elecIsoCut(v_electrons.at(2).eta, v_electrons.at(2).pt, v_electrons.at(2).iso)==true) and (elecIsoCut(v_electrons.at(3).eta, v_electrons.at(3).pt, v_electrons.at(3).iso)==false))
    {
      weight *= v_electrons.at(0).sf*v_electrons.at(1).sf*v_electrons.at(2).sf*v_electrons.at(3).sf;
      bool ifpass;
      double compare = 15; //Min value of |Mll - MZ|
      int lep_zcand_idx1, lep_zcand_idx2, lep_nonzcand_idx1, lep_nonzcand_idx2;
      lep_zcand_idx1 = lep_zcand_idx2 = lep_nonzcand_idx1 = lep_nonzcand_idx2 = -999;
      ...
      h_nJets->Fill(nj, weight);
      //if(minChi2 < 100.0 and nb==0 and nj==0 and fabs(lv_comb01.DeltaPhi(lv_comb23)) < 2.5 and fabs(lv_comb02.DeltaPhi(lv_comb13)) < 2.5)
      if(nb==0 and lep_zcand_idx1 >= 0 and lep_zcand_idx2 >= 0 and met_pt > 40.0)
      {
        if(Sample=="MC") 
        {
          h_min_chi_weight->Fill(minChi2, weight);
        ...
        {
          h_min_chi_weight->Fill(minChi2, 1.0);
          fillElHistCollection4l(Cut1_4l, v_electrons.at(0).pt, v_electrons.at(1).pt, v_electrons.at(2).pt, v_electrons.at(3).pt, v_electrons.at(0).eta, v_electrons.at(1).eta, v_electrons.at(2).eta, v_electrons.at(3).eta, v_electrons.at(0).phi, v_electrons.at(1).phi, v_electrons.at(2).phi, v_electrons.at(3).phi, v_electrons.at(0).sip3d, v_electrons.at(1).sip3d, v_electrons.at(2).sip3d, v_electrons.at(3).sip3d, v_electrons.at(0).dxy, v_electrons.at(1).dxy, v_electrons.at(2).dxy, v_electrons.at(3).dxy, v_electrons.at(0).dz, v_electrons.at(1).dz, v_electrons.at(2).dz, v_electrons.at(3).dz, v_electrons.at(0).iso, v_electrons.at(1).iso, v_electrons.at(2).iso, v_electrons.at(3).iso, met_pt, nj, nb, (v_electrons.at(0).lep_lv+v_electrons.at(1).lep_lv+v_electrons.at(2).lep_lv+v_electrons.at(3).lep_lv).M(), 1.0);
    ...
    if(v_muons.size()==2 and v_muons.at(0).iso < 0.25 and v_muons.at(1).iso < 0.25 and v_electrons.size()==2 and (elecIsoCut(v_electrons.at(0).eta, v_electrons.at(0).pt, v_electrons.at(0).iso)==true) and (elecIsoCut(v_electrons.at(1).eta, v_electrons.at(1).pt, v_electrons.at(1).iso)==false))
    {
      weight *= v_muons.at(0).sf*v_muons.at(1).sf*v_electrons.at(0).sf*v_electrons.at(1).sf; 
      ...
      {
        fillElMuHistCollection4l(Cut1_4lElMu, v_electrons.at(0).pt, v_electrons.at(1).pt, v_muons.at(0).pt, v_muons.at(1).pt, v_electrons.at(0).eta, v_electrons.at(1).eta, v_muons.at(0).eta, v_muons.at(1).eta, v_electrons.at(0).phi, v_electrons.at(1).phi, v_muons.at(0).phi, v_muons.at(1).phi, v_electrons.at(0).sip3d, v_electrons.at(1).sip3d, v_muons.at(0).sip3d, v_muons.at(1).sip3d, v_electrons.at(0).dxy, v_electrons.at(1).dxy, v_muons.at(0).dxy, v_muons.at(1).dxy, v_electrons.at(0).dz, v_electrons.at(1).dz, v_muons.at(0).dz, v_muons.at(1).dz, v_electrons.at(0).iso, v_electrons.at(1).iso, v_muons.at(0).iso, v_muons.at(1).iso, met_pt, nj, nb, (v_electrons.at(0).lep_lv+v_electrons.at(1).lep_lv+v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M(), (v_electrons.at(0).lep_lv+v_electrons.at(1).lep_lv).M(), (v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M(), 1.0);
      ...
      h_ee_mm_ElMu->Fill((v_electrons.at(0).lep_lv+v_electrons.at(1).lep_lv).M(), (v_muons.at(0).lep_lv+v_muons.at(1).lep_lv).M());
    }
    if(v_muons.size()==2 and v_muons.at(0).iso < 0.25 and v_muons.at(1).iso > 0.25 and v_electrons.size()==2 and (elecIsoCut(v_electrons.at(0).eta, v_electrons.at(0).pt, v_electrons.at(0).iso)==true) and (elecIsoCut(v_electrons.at(1).eta, v_electrons.at(1).pt, v_electrons.at(1).iso)==true))
    {
      weight *= v_muons.at(0).sf*v_muons.at(1).sf*v_electrons.at(0).sf*v_electrons.at(1).sf;
      if(Sample=="MC") h_TotalEvents_2El2Mu->Fill(1, weight);
      else if(Sample=="Data") h_TotalEvents_2El2Mu->Fill(1, 1.0);
    ...
    if(v_leptons.size()==5)
    {
      ...
      if(z_lep1_temp >= 0 and z_lep2_temp >= 0 and z_lep3_temp >= 0 and z_lep4_temp >= 0 and w_lep_temp >= 0) //and nb==0)
      {
        ...
        /*TLorentzVector W_Met, LEP;
        W_Met.SetPxPyPzE(met_pt*TMath::Cos(met_phi), met_pt*TMath::Sin(met_phi), 0.0, sqrt(met_pt*met_pt));
        LEP.SetPtEtaPhiE(v_leptons.at(z_lep1_temp).lep_lv.Pt(), v_leptons.at(z_lep1_temp).lep_lv.Eta(), v_leptons.at(z_lep1_temp).lep_lv.Phi(), v_leptons.at(z_lep1_temp).lep_lv.E());
        // type0 calculation of neutrino pZ
        METzCalculator_Run2 NeutrinoPz;
        NeutrinoPz.SetMET(W_Met);
        NeutrinoPz.SetLepton(LEP);
        NeutrinoPz.SetLeptonType(v_leptons.at(z_lep1_temp).id); 
        
        double pz1 = NeutrinoPz.Calculate();

        // don't touch the neutrino pT
        TLorentzVector W_neutrino_type0_met; 
        W_neutrino_type0_met.SetPxPyPzE(W_Met.Px(),W_Met.Py(),pz1,sqrt(W_Met.Pt()*W_Met.Pt()+pz1*pz1));

        // change the neutrino pT in case of complex solution in order to make it real
        TLorentzVector W_neutrino_type0; 
        W_neutrino_type0.SetPxPyPzE(W_Met.Px(),W_Met.Py(),pz1,sqrt(W_Met.Pt()*W_Met.Pt()+pz1*pz1));

        if(NeutrinoPz.IsComplex()) 
        {// if this is a complex, change MET
          double nu_pt1 = NeutrinoPz.getPtneutrino(1);
          double nu_pt2 = NeutrinoPz.getPtneutrino(2);
          TLorentzVector W_neutrino_1;
          W_neutrino_1.SetPxPyPzE(nu_pt1*TMath::Cos(met_phi), nu_pt1*TMath::Sin(met_phi), pz1, sqrt(nu_pt1*nu_pt1 + pz1*pz1));
          TLorentzVector W_neutrino_2;
          W_neutrino_2.SetPxPyPzE(nu_pt2*TMath::Cos(met_phi), nu_pt2*TMath::Sin(met_phi), pz1, sqrt(nu_pt2*nu_pt2 + pz1*pz1));
          if ( fabs((LEP+W_neutrino_1).M()-Mw) < fabs((LEP+W_neutrino_2).M()-Mw)) W_neutrino_type0 = W_neutrino_1;
          else W_neutrino_type0 = W_neutrino_2;
        }
 
        TLorentzVector NU0, W;
        NU0.SetPxPyPzE(met_pt*TMath::Cos(met_phi), met_pt*TMath::Sin(met_phi), pz1, TMath::Sqrt(met_pt*met_pt+pz1*pz1));
        W = LEP + NU0;

        if(LEP.Pt()<=0 || W_Met.Pt() <= 0 ){ std::cerr<<" Negative Lepton - Neutrino Pt "<<std::endl; continue ; }
        if(sameVal(W.M(), Mw)) h_TotalEvents_5l->Fill(5, weight);
        //float Ml = 0.0;
        if(abs(v_leptons.at(w_lep_temp).id)==11) Ml = MUON_MASS;
        else if(abs(v_leptons.at(w_lep_temp).id)==13) Ml = ELECTRON_MASS;
       
        float pTPlus = wMassConstraintPlus(v_leptons.at(w_lep_temp).lep_lv.E(), v_leptons.at(w_lep_temp).lep_lv.Px(), v_leptons.at(w_lep_temp).lep_lv.Py(), v_leptons.at(w_lep_temp).lep_lv.Pz(), met.Pt(), met.Px(), met.Py(), Mw, Ml);

        float pTMinus = wMassConstraintMinus(v_leptons.at(w_lep_temp).lep_lv.E(), v_leptons.at(w_lep_temp).lep_lv.Px(), v_leptons.at(w_lep_temp).lep_lv.Py(), v_leptons.at(w_lep_temp).lep_lv.Pz(), met.Pt(), met.Px(), met.Py(), Mw, Ml);
        
        //std::cout << "pTPlus = " << pTPlus << ", pTMinus = " << pTMinus << " leptonic pZ = " << v_leptons.at(w_lep_temp).lep_lv.Pz() << std::endl;
        if(sameVal(pTPlus, met.Pz()) or sameVal(pTMinus, met.Pz())) h_TotalEvents_5l->Fill(5, weight);
        */ 
        if(debug)
        {
