...
void makeleptonPlots()
{
  ...
  hLeptonPtOne->SetMaximum(100000);
  hLeptonPtOne->SetTitle("");
  hLeptonPtOne->SetLineWidth(2);
  hLeptonPtOne->Rebin(10);
  hLeptonPtOne->GetXaxis()->SetRangeUser(0, 750.0);
  hLeptonPtOne->SetMinimum(5.0);
  hLeptonPtOne->SetStats(kFALSE);
  hLeptonPtOne->GetYaxis()->SetTitleOffset(1.3);
  ...
  TLegend *leg1 = new TLegend(0.38,0.55,0.80,0.82,NULL,"brNDC");
  ...
  c1.SaveAs("lepton_ZZZ.png");
  c1.SaveAs("lepton_ZZZ.pdf");
}
