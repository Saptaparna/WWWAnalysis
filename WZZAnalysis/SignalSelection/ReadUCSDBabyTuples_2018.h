...
double recoSFEl_Up(TFile* fileData, TH2F* hist2D, double pt, double eta)
{  
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(eta);
   Int_t biny = yaxis->FindBin(pt);
   if(pt > 500.0) return 1.0;
   else return (hist2D->GetBinContent(binx, biny) + hist2D->GetBinError(binx, biny));
}

double vetoSFEl_Up(TFile* fileData, TH2F* hist2D, double pt, double eta)
{
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(eta);
...
double recoSFMu_Up(TFile* fileData, TH2F* hist2D, double pt, double eta)
{
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(pt);
   Int_t biny = yaxis->FindBin(fabs(eta));
   if(pt > 120.0) return 1.0;
   if(pt > 20.0) return (hist2D->GetBinContent(binx, biny) + hist2D->GetBinError(binx, biny));
   else return 1.0;
}

double recoLowPtSFMu_Up(TFile* fileData, TH2F* hist2D, double pt, double eta)
{
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(pt);
   Int_t biny = yaxis->FindBin(fabs(eta));
   if(pt < 20) return (hist2D->GetBinContent(binx, biny) + hist2D->GetBinError(binx, biny));
   else return 1.0;
}

double isoSFMu_Up(TFile* fileData, TH2F* hist2D, double pt, double eta)
{
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(std::max((double) pt, 15.1));
...
double recoSFEl_Down(TFile* fileData, TH2F* hist2D, double pt, double eta)
{
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(eta);
...
double vetoSFEl_Down(TFile* fileData, TH2F* hist2D, double pt, double eta)
{
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(eta);
...
double recoSFMu_Down(TFile* fileData, TH2F* hist2D, double pt, double eta)
{
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(pt);
...
double recoLowPtSFMu_Down(TFile* fileData, TH2F* hist2D, double pt, double eta)
{
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(pt);
...
double isoSFMu_Down(TFile* fileData, TH2F* hist2D, double pt, double eta)
{  
   TAxis *xaxis = hist2D->GetXaxis();
   TAxis *yaxis = hist2D->GetYaxis();
   Int_t binx = xaxis->FindBin(std::max((double) pt, 15.1));
