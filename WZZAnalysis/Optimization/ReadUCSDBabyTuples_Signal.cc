...
int ReadUCSDBabyTuples_Signal(std::string infile, std::string treeStr, std::string Sample, std::string Trigger="None")
{
  ...
  TH1D *h_TotalEvents_5l_Optimize_Cut1 = new TH1D("h_TotalEvents_5l_Optimize_Cut1", "h_TotalEvents_5l_Optimize_Cut1", 15, -0.5, 14.5); h_TotalEvents_5l_Optimize_Cut1->Sumw2();
  TH1D *h_TotalEvents_5l_Optimize_Cut2 = new TH1D("h_TotalEvents_5l_Optimize_Cut2", "h_TotalEvents_5l_Optimize_Cut2", 15, -0.5, 14.5); h_TotalEvents_5l_Optimize_Cut2->Sumw2();
  TH1D *h_TotalEvents_5l_Optimize_Cut3 = new TH1D("h_TotalEvents_5l_Optimize_Cut3", "h_TotalEvents_5l_Optimize_Cut3", 15, -0.5, 14.5); h_TotalEvents_5l_Optimize_Cut3->Sumw2();
  ...
  for (int i=0; i<nEvents; ++i)
  {
	...
	if(mT > 50.0 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 30.0) h_Iso_mT50_FifthLepton_pT30->Fill(v_leptons.at(w_lep_temp).iso, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 5) h_TotalEvents_5l_Optimize_Cut1->Fill(1, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 10) h_TotalEvents_5l_Optimize_Cut1->Fill(2, weight); 
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 15) h_TotalEvents_5l_Optimize_Cut1->Fill(3, weight);  
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 20) h_TotalEvents_5l_Optimize_Cut1->Fill(4, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 25) h_TotalEvents_5l_Optimize_Cut1->Fill(5, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 30) h_TotalEvents_5l_Optimize_Cut1->Fill(6, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 35) h_TotalEvents_5l_Optimize_Cut1->Fill(7, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 40) h_TotalEvents_5l_Optimize_Cut1->Fill(8, weight); 
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 45) h_TotalEvents_5l_Optimize_Cut1->Fill(9, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 50) h_TotalEvents_5l_Optimize_Cut1->Fill(10, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 55) h_TotalEvents_5l_Optimize_Cut1->Fill(11, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 60) h_TotalEvents_5l_Optimize_Cut1->Fill(12, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 65) h_TotalEvents_5l_Optimize_Cut1->Fill(13, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 70) h_TotalEvents_5l_Optimize_Cut1->Fill(14, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 80) h_TotalEvents_5l_Optimize_Cut1->Fill(15, weight);
        if(mT > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2 and v_leptons.at(w_lep_temp).lep_lv.Pt() > 100) h_TotalEvents_5l_Optimize_Cut1->Fill(16, weight);
        //second var
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1 and mT > 10) h_TotalEvents_5l_Optimize_Cut2->Fill(1, weight);  
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1 and mT > 20) h_TotalEvents_5l_Optimize_Cut2->Fill(2, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1 and mT > 30) h_TotalEvents_5l_Optimize_Cut2->Fill(3, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1 and mT > 40) h_TotalEvents_5l_Optimize_Cut2->Fill(4, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1 and mT > 50) h_TotalEvents_5l_Optimize_Cut2->Fill(5, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1 and mT > 60) h_TotalEvents_5l_Optimize_Cut2->Fill(6, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1 and mT > 70) h_TotalEvents_5l_Optimize_Cut2->Fill(7, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1 and mT > 80) h_TotalEvents_5l_Optimize_Cut2->Fill(8, weight);
        //third var
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and mT > 50 and fabs(v_leptons.at(w_lep_temp).iso) < 0.3) h_TotalEvents_5l_Optimize_Cut3->Fill(1, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and mT > 50 and fabs(v_leptons.at(w_lep_temp).iso) < 0.2) h_TotalEvents_5l_Optimize_Cut3->Fill(2, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and mT > 50 and fabs(v_leptons.at(w_lep_temp).iso) < 0.1) h_TotalEvents_5l_Optimize_Cut3->Fill(3, weight);
        if(v_leptons.at(w_lep_temp).lep_lv.Pt() > 10.0 and mT > 50 and fabs(v_leptons.at(w_lep_temp).iso) < 0.05) h_TotalEvents_5l_Optimize_Cut3->Fill(4, weight);
        double Mz = 91.1876;
