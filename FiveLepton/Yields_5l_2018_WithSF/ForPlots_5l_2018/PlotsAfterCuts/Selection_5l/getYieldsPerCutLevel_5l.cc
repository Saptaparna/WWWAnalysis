...
void getYieldsPerCutLevel_5l_nocuts()
{
  ...
  std::cout << "Process  & Normalized yields  \\\\ [0.5ex]" << std::endl;
  std::cout << "\\hline" << std::endl;
  std::cout << "$WZ$"              << " & "   << std::setprecision(3) << hWZ_5l1->GetBinContent(2)*LUMI2018 + hWZ_5l2->GetBinContent(2)*LUMI2018 << " $\\pm$ " << sqrt(hWZ_5l1->GetBinError(2)*LUMI2018*hWZ_5l1->GetBinError(2)*LUMI2018 + hWZ_5l2->GetBinError(2)*LUMI2018*hWZ_5l2->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "$t\\bar{t}W$"      << " & "   << std::setprecision(2) << hTTW_5l->GetBinContent(2)*LUMI2018 <<  " $\\pm$ " << hTTW_5l->GetBinError(2)*LUMI2018 << " \\\\ " << std::endl;
  std::cout << "$t\\bar{t}Z$"      << " & "   << std::setprecision(3) << hTTZ_5l1->GetBinContent(2)*LUMI2018 + hTTZ_5l2->GetBinContent(2)*LUMI2018 <<  " $\\pm$ " << sqrt(hTTZ_5l1->GetBinError(2)*LUMI2018*hTTZ_5l1->GetBinError(2)*LUMI2018 + hTTZ_5l2->GetBinError(2)*LUMI2018*hTTZ_5l2->GetBinError(2)*LUMI2018)<< " \\\\ " << std::endl;
  std::cout << "$ZZ$"              << " & "   << std::setprecision(3) << hZZ1_5l->GetBinContent(2)*LUMI2018 + hZZ2_5l->GetBinContent(2)*LUMI2018 + hZZ3_5l->GetBinContent(2)*LUMI2018 + hZZ4_5l->GetBinContent(2)*LUMI2018 + hZZ5_5l->GetBinContent(2)*LUMI2018 + hZZ6_5l->GetBinContent(2)*LUMI2018 + hZZ7_5l->GetBinContent(2)*LUMI2018 + hZZ8_5l->GetBinContent(2)*LUMI2018 + hZZ9_5l->GetBinContent(2)*LUMI2018 + hZZ10_5l->GetBinContent(2)*LUMI2018 << " $\\pm$ " << sqrt(hZZ1_5l->GetBinError(2)*LUMI2018*hZZ1_5l->GetBinError(2)*LUMI2018 + hZZ2_5l->GetBinError(2)*LUMI2018*hZZ2_5l->GetBinError(2)*LUMI2018 + hZZ3_5l->GetBinError(2)*LUMI2018*hZZ3_5l->GetBinError(2)*LUMI2018 + hZZ4_5l->GetBinError(2)*LUMI2018*hZZ4_5l->GetBinError(2)*LUMI2018 + hZZ5_5l->GetBinError(2)*LUMI2018*hZZ5_5l->GetBinError(2)*LUMI2018 + hZZ6_5l->GetBinError(2)*LUMI2018*hZZ6_5l->GetBinError(2)*LUMI2018 + hZZ7_5l->GetBinError(2)*LUMI2018*hZZ7_5l->GetBinError(2)*LUMI2018 + hZZ8_5l->GetBinError(2)*LUMI2018*hZZ8_5l->GetBinError(2)*LUMI2018 + hZZ9_5l->GetBinError(2)*LUMI2018*hZZ9_5l->GetBinError(2)*LUMI2018 + hZZ10_5l->GetBinError(2)*LUMI2018*hZZ10_5l->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "$t\\bar{t}$"       << " & "   << std::setprecision(3) << hTTbar1_5l->GetBinContent(2)*LUMI2018 << " $\\pm$ " << sqrt(hTTbar1_5l->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "DY"                << " & "   << hDY1050_5l->GetBinContent(2)*LUMI2018 + hDY50_5l->GetBinContent(2)*LUMI2018 <<" $\\pm$ " << sqrt(hDY1050_5l->GetBinError(2)*LUMI2018*hDY1050_5l->GetBinError(2)*LUMI2018 + hDY50_5l->GetBinError(2)*LUMI2018*hDY50_5l->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "ww$\\gamma$"                << " & "   << hWWG_5l->GetBinContent(2)*LUMI2018 << " $\\pm$ " << sqrt(hWWG_5l->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "wz$\\gamma$"                << " & "   << hWZG_5l->GetBinContent(2)*LUMI2018 << " $\\pm$ " << sqrt(hWZG_5l->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "\\hline\\hline" << std::endl;
  std::cout << "Signal: SM wzz"    << " & "   << hSignal_WZZ_5l->GetBinContent(2)*LUMI2018 << " $\\pm$ " << sqrt(hSignal_WZZ_5l->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "Signal: SM zzz"    << " & "   << hSignal_ZZZ_5l->GetBinContent(2)*LUMI2018 << " $\\pm$ " << sqrt(hSignal_ZZZ_5l->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "Signal: zh $\\rightarrow$ zz"    << " & "   << hSignal_ZH_ZZ_5l->GetBinContent(2)*LUMI2018 << " $\\pm$ " << sqrt(hSignal_ZH_ZZ_5l->GetBinError(2)*LUMI2018) << " \\\\ " << std::endl;
  std::cout << "\\hline\\hline" << std::endl;
  std::cout << "\\end{tabular}" << std::endl;
  std::cout << "\\end{center}" << std::endl;
