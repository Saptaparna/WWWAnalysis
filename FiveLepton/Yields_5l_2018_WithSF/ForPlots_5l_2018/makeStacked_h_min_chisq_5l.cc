...
void makeStacked_h_min_chisq_5l(){
  ...
  TH1F *h2 = (TH1F*)file2->Get("h_min_chisq_5l");
  h2->Rebin(50);
  ...
  TH1F *h16 = (TH1F*)file16->Get("h_min_chisq_5l");
  h16->Rebin(50);
  h16->Scale(LUMI);
  ...
  TH1F *h17 = (TH1F*)file17->Get("h_min_chisq_5l");
  h17->Rebin(50);
  h17->Scale(LUMI);
  ...
  TH1F *h0 = (TH1F*)file0->Get("h_min_chisq_5l");
  h0->Rebin(50);
  ...
  TH1F *h1 = (TH1F*)file1->Get("h_min_chisq_5l");
  h1->Rebin(50);
  ...
  TH1F *h3 = (TH1F*)file3->Get("h_min_chisq_5l");
  h3->Rebin(50);
  ...
  TH1F *h4 = (TH1F*)file4->Get("h_min_chisq_5l");
  h4->Rebin(50);
  h4->Scale(LUMI);
  ...
  TH1F *h5 = (TH1F*)file5->Get("h_min_chisq_5l");
  h5->Rebin(50);
  h5->Scale(LUMI);
  ...
  TH1F *h6 = (TH1F*)file6->Get("h_min_chisq_5l");
  h6->Rebin(50);
  h6->Scale(LUMI);
  ...
  TH1F *h7 = (TH1F*)file7->Get("h_min_chisq_5l");
  h7->Rebin(50);
  h7->Scale(LUMI);
  ...
  TH1F *h8 = (TH1F*)file8->Get("h_min_chisq_5l");
  h8->Rebin(50);
  h8->Scale(LUMI);
  ...
  TH1F *h9 = (TH1F*)file9->Get("h_min_chisq_5l");
  h9->Rebin(50);
  h9->Scale(LUMI);
  ...
  TH1F *h10 = (TH1F*)file10->Get("h_min_chisq_5l");
  h10->Rebin(50);
  h10->Scale(LUMI);
  ...
  TH1F *h11 = (TH1F*)file11->Get("h_min_chisq_5l");
  h11->Rebin(50);
  h11->Scale(LUMI);
  ...
  TH1F *h12 = (TH1F*)file12->Get("h_min_chisq_5l");
  h12->Rebin(50);
  h12->Scale(LUMI);
  ...
  TH1F *h13 = (TH1F*)file13->Get("h_min_chisq_5l");
  h13->Rebin(50);
  h13->Scale(LUMI);
  ...
  TH1F *h14 = (TH1F*)file14->Get("h_min_chisq_5l");
  h14->Rebin(50);
  h14->Scale(LUMI);
  ...
  TH1F *h15 = (TH1F*)file15->Get("h_min_chisq_5l");
  h15->Rebin(50);
  h15->Scale(LUMI);
  ...
  hs->Draw("HIST");
  //hs->SetMaximum(50000.0);
  hs->SetMaximum(3.0);
  hs->GetXaxis()->SetRangeUser(0.0, 200.0);
  hs->SetMinimum(0.1);
  hs->GetXaxis()->SetTitle("Min #chi^{2}");
  ...
  TH1F *h20 = (TH1F*)file20->Get("h_min_chisq_5l");
  h20->Rebin(50);
  h20->Scale(LUMI*5);
  ...
  */
  ...
  TLatex *tLumi = new TLatex(0.90,0.955,"59.7 fb^{-1} (13 TeV)");
  tLumi->SetNDC();
  ...
  leg1SS->AddEntry(h20, "WZZ signal X 5", "l");
  leg1SS->Draw();
  ...
  */
  ...
  c1.SaveAs("h_min_chisq_5l.pdf");
  c1.SaveAs("h_min_chisq_5l.png");
