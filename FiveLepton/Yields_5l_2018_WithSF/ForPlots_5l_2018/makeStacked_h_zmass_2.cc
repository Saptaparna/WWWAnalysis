...
void makeStacked_h_zmass_2(){
  ...
  TH1F *h2 = (TH1F*)file2->Get("h_zmass_2");
  h2->Rebin(5);
  ...
  TH1F *h16 = (TH1F*)file16->Get("h_zmass_2");
  h16->Rebin(5);
  h16->Scale(LUMI);
  ...
  TH1F *h17 = (TH1F*)file17->Get("h_zmass_2");
  h17->Rebin(5);
  h17->Scale(LUMI);
  ...
  TH1F *h0 = (TH1F*)file0->Get("h_zmass_2");
  h0->Rebin(5);
  ...
  TH1F *h1 = (TH1F*)file1->Get("h_zmass_2");
  h1->Rebin(5);
  ...
  TH1F *h3 = (TH1F*)file3->Get("h_zmass_2");
  h3->Rebin(5);
  ...
  TH1F *h4 = (TH1F*)file4->Get("h_zmass_2");
  h4->Rebin(5);
  h4->Scale(LUMI);
  ...
  TH1F *h5 = (TH1F*)file5->Get("h_zmass_2");
  h5->Rebin(5);
  h5->Scale(LUMI);
  ...
  TH1F *h6 = (TH1F*)file6->Get("h_zmass_2");
  h6->Rebin(5);
  h6->Scale(LUMI);
  ...
  TH1F *h7 = (TH1F*)file7->Get("h_zmass_2");
  h7->Rebin(5);
  h7->Scale(LUMI);
  ...
  TH1F *h8 = (TH1F*)file8->Get("h_zmass_2");
  h8->Rebin(5);
  h8->Scale(LUMI);
  ...
  TH1F *h9 = (TH1F*)file9->Get("h_zmass_2");
  h9->Rebin(5);
  h9->Scale(LUMI);
  ...
  TH1F *h10 = (TH1F*)file10->Get("h_zmass_2");
  h10->Rebin(5);
  h10->Scale(LUMI);
  ...
  TH1F *h11 = (TH1F*)file11->Get("h_zmass_2");
  h11->Rebin(5);
  h11->Scale(LUMI);
  ...
  TH1F *h12 = (TH1F*)file12->Get("h_zmass_2");
  h12->Rebin(5);
  h12->Scale(LUMI);
  ...
  TH1F *h13 = (TH1F*)file13->Get("h_zmass_2");
  h13->Rebin(5);
  h13->Scale(LUMI);
  ...
  TH1F *h14 = (TH1F*)file14->Get("h_zmass_2");
  h14->Rebin(5);
  h14->Scale(LUMI);
  ...
  TH1F *h15 = (TH1F*)file15->Get("h_zmass_2");
  h15->Rebin(5);
  h15->Scale(LUMI);
  ...
  hs->SetMinimum(0.1);
  hs->GetXaxis()->SetTitle("Lepton pair mass combination 2");
  ...
  TH1F *h20 = (TH1F*)file20->Get("h_zmass_2");
  h20->Rebin(5);
  h20->Scale(LUMI);
  ...
  */
  ...
  h_ratio->SetTitle("; Lepton pair mass combination 2");
  ...
  */
  ...
  c1.SaveAs("h_zmass_2.pdf");
  c1.SaveAs("h_zmass_2.png");
